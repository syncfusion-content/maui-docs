...
To populate the treemap items, utilize the `DataSource` property of `SfTreeMap`. Along with `DataSourceThe`. Alongside, consider the following properties of `SfTreeMap` while initializing the tree map control.
