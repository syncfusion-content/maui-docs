...
description: Learn about the introduction to Syncfusion<sup>&reg;</sup> .NET MAUI TreeMap (SfTreeMap) control, its basic features, and the functionalities of treemap.
platform: maui
...
- [Sunburst Chart](https://help.syncfusion.com/maui/sunburst-chart/overview) for visualizing hierarchical data using a radial layout.
...
<a href="https://www.syncfusion.com/maui-controls/maui-tree-map" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/TreeMap" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/treemap" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
