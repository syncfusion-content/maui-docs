...
- [Getting Started](https://help.syncfusion.com/maui/chips/getting-started) shows a step‑by‑step guide to begin using the Chips control.  
- [Chip Types](https://help.syncfusion.com/maui/chips/chips-types) explores different chip variations such as input, choice, filter, and action chips, and explains how each type can be used to represent data or user actions.  
- [Customization](https://help.syncfusion.com/maui/chips/customization) helps personalize chip appearance by modifying styles, colors, icons, and templates to match your application’s design.  
...
<a href="https://www.syncfusion.com/maui-controls/maui-chips" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Chips" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/chips" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/1274" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
      Explore a real-world application that demonstrates the practical use of the Chips.
    </div>
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Chips" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
