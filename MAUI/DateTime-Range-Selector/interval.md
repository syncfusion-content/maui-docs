---
layout: post
title: Interval in.NET MAUI Range Selector control | Syncfusion<sup>®</sup> 
description: Learn here all about adding the Interval feature of Syncfusion<sup>®</sup> .NET MAUI Range Selector (SfDateTimeRangeSelector) control and more.
platform: maui
