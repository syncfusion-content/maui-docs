...
description: Enable and customize the Liquid Glass Effect in the Syncfusion® .NET MAUI DateTime Range Selector to add translucent, adaptive glass-like visuals and interactive feedback.
platform: MAUI
