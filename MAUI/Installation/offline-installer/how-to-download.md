...
The Syncfusion<sup>®</sup> .NET MAUI installer can be downloaded from the [Syncfusion website](https://www.syncfusion.com/maui-controls). You can either download the licensed installer or try our trial installer, depending on your license.
...
* Start a trial through [NuGet.org](https://www.nuget.org/packages?q=syncfusion).

### Download free trial setup

1. Visit the [Download Free Trial](https://www.syncfusion.com/downloads) page and select the **.NET MAUI** platform.
2. After completing the required form or signing in with your registered Syncfusion<sup>®</sup> account, download the .NET MAUI trial installer from the confirmation page (as shown in the screenshot below).
...
6. Click **More Download Options** (element 2 in the screenshot) to get the Essential Studio<sup>®</sup> .NET MAUI offline trial installer, available in EXE and ZIP formats.
...
6. You can download other platform or add-on installers by selecting **More Downloads Options** (element 3 in the screenshot).

   ![Syncfusion License and Downloads page](images/license-download.png)

7. For Windows, EXE and ZIP formats are available for download. They are both offline installers.

   ![Syncfusion offline installer download](images/start-trial-download-offline-installer.png)

For step-by-step installation guidelines, see [Installing the .NET MAUI Offline Installer](https://help.syncfusion.com/maui/installation/offline-installer/how-to-install).