---
layout: post
title: Installing Syncfusion<sup>®</sup> .NET MAUI web installer - Syncfusion<sup>®</sup>
description: Learn here about how to install Syncfusion<sup>®</sup> .NET MAUI web installer after downloading from our Syncfusion<sup>®</sup> website.
platform: MAUI
...
The steps below show how to install Essential Studio<sup>®</sup> .NET MAUI Web Installer.

1.  Open the Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> .NET MAUI Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2. 	The Syncfusion<sup>®</sup> .NET MAUI Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion<sup>®</sup> .NET MAUI installer can be uninstalled in two ways.

   * Uninstall the .NET MAUI using the Syncfusion<sup>®</sup> .NET MAUI web installer
   * Uninstall the .NET MAUI from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> .NET MAUI installer.
  
**Option 1: Uninstall the .NET MAUI using the Syncfusion<sup>®</sup> .NET MAUI web installer**
...
N> If the **Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> for .NET MAUI {version}** entry is selected from the Windows control panel, the Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> .NET MAUI alone will be removed and the below default MSI uninstallation window will be displayed.	


1.  The Syncfusion<sup>®</sup> .NET MAUI Web Installer's welcome wizard will be displayed. Click the Next button
