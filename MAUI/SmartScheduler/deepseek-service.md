---
layout: post
title: DeepSeek AI for AI-Powered Scheduler | Syncfusion®
description: Learn how to integrate the DeepSeek AI services with Syncfusion<sup>&reg;</sup> AI-Powered Scheduler (SfSmartScheduler) control.
platform: maui
control: SfSmartScheduler
documentation: ug
---

# DeepSeek AI Integration with .NET MAUI AI-Powered Scheduler

The Syncfusion [.NET MAUI AI-Powered Scheduler] (SfSmartScheduler) can provide AI-powered suggestions while scheduling appointments. You can integrate DeepSeek using the `IChatInferenceService` interface, which standardizes communication between the scheduler and your custom AI service.
