---
layout: post
title: Gemini AI for AI-Powered Scheduler | Syncfusion®
description: Learn how to implement a custom AI service using Google's Gemini API with Syncfusion<sup>&reg;</sup> AI-Powered Scheduler (SfSmartScheduler) control.
platform: maui
control: SfSmartScheduler
documentation: ug
---

# Gemini AI Integration with .NET MAUI AI-Powered Scheduler

The Syncfusion [.NET MAUI AI-Powered Scheduler] provides AI-powered suggestions for appointment scheduling. By default, it works with providers like OpenAI or Azure OpenAI, but you can integrate `Google Gemini AI` using the `IChatInferenceService` interface. This guide explains how to implement and register Gemini AI for the AI-Powered Scheduler in a .NET MAUI app.
