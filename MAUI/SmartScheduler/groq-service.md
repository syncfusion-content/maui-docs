---
layout: post
title: Groq AI Integration with AI-Powered Scheduler | Syncfusion®
description: Learn how to implement a custom AI service using the Groq API with Syncfusion<sup>&reg;</sup> AI-Powered Scheduler (SfSmartScheduler) control.
platform: maui
control: SfSmartScheduler
documentation: ug
---

# Groq AI Integration with .NET MAUI AI-Powered Scheduler

The Syncfusion [.NET MAUI AI-Powered Scheduler] (SfSmartScheduler) can show AI‑powered suggestions while appointment scheduling. You can integrate `Groq` using the `IChatInferenceService` interface and Groq’s OpenAI‑compatible Chat Completions API for fast, low‑latency results.
