...
description: Learn about styles in Syncfusion<sup>&reg;</sup> .NET MAUI AI-Powered Scheduler control to customize the assist view appearance with colors, fonts, and backgrounds.
platform: MAUI
