...
The following code sample creates a default bar pointer with the value 50. The default [`PointerSize`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.BarPointer.html#Syncfusion_Maui_Gauges_BarPointer_PointerSize) is 10.
...
![Initialize .NET MAUI Linear Gauge for bar pointer](images/bar-pointer/default_bar_pointer.PNG)
...
![Change the bar pointer thickness in .NET MAUI Linear Gauge](images/bar-pointer/bar_thickness.PNG)
...
![Change the bar pointer edge style in .NET MAUI Linear Gauge](images/bar-pointer/edge_style.PNG)

## Customize the position

By default, the bar pointer is positioned cross to the scale. This position can be changed by the [`Position`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.LinearPointer.html#Syncfusion_Maui_Gauges_LinearPointer_Position) property of a pointer. It is possible to position the bar pointer [`Inside`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeElementPosition.html#Syncfusion_Maui_Gauges_GaugeElementPosition_Inside), [`Cross`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeElementPosition.html#Syncfusion_Maui_Gauges_GaugeElementPosition_Cross), or [`Outside`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeElementPosition.html#Syncfusion_Maui_Gauges_GaugeElementPosition_Outside) the scale. The default position is [`Cross`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeElementPosition.html#Syncfusion_Maui_Gauges_GaugeElementPosition_Cross). The following code sample demonstrates how to change the bar pointer position to inside the scale.
...
![Customize .NET MAUI Linear Gauge bar pointer offset](images/bar-pointer/bar_pointer_offset.PNG)
...
![Apply color to bar pointer in .NET MAUI Linear Gauge](images/bar-pointer/bar_color.PNG)

## Apply gradient

The gradient can be applied by using the [`GradientStops`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.BarPointer.html#Syncfusion_Maui_Gauges_BarPointer_GradientStops) property of bar pointer, which accepts a collection of [`GaugeGradientStop`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeGradientStop.html) objects. Each `GaugeGradientStop` defines a [`Value`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeGradientStop.html#Syncfusion_Maui_Gauges_GaugeGradientStop_Value) (the scale position) and a [`Color`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeGradientStop.html#Syncfusion_Maui_Gauges_GaugeGradientStop_Color) (the color at that position). The following code sample demonstrates how to apply a linear gradient to the bar pointer.
...
![Apply gradient to bar pointer in .NET MAUI Linear Gauge](images/bar-pointer/gradient_bar.PNG)
