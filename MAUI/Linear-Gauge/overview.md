...
<a href="https://www.syncfusion.com/maui-controls/maui-linear-gauge" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Gauges/SampleBrowser.Maui.Gauges/Samples/LinearGauge" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
      Explore a real-world application that demonstrates the practical use of the Linear Gauge.
    </div>
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Gauges/SampleBrowser.Maui.Gauges/Samples/LinearGauge" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
