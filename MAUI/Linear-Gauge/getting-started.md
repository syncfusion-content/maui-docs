...
## Step 4: Add a Basic LinearGauge

1. To initialize the control, import the Core namespace into your code.
2. Initialize [SfLinearGauge](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauge.SfLinearGauge.html?tabs=tabid-1).
...
{% highlight c# %}
    ...
    using Syncfusion.Maui.LinearGauge;
