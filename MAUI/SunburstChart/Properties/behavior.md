---
layout: post
title: SunburstTooltipBehaviors in .NET MAUI Sunburst Chart | Syncfusion®
description: This section lists the public API members of the SunburstTooltipSettings class available in the Syncfusion® .NET MAUI Sunburst Chart API.
platform: maui
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_Background" aria-label="View Background property in API reference">Background</a></td>
    ...
    <td>Controls the brush used to render the tooltip background.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_Duration" aria-label="View Duration property in API reference">Duration</a></td>
    ...
    <td>Controls how long the tooltip remains visible after it is displayed.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_FontAttributes" aria-label="View FontAttributes property in API reference">FontAttributes</a></td>
    ...
    <td>Specifies the font styling applied to the tooltip text, such as normal, bold, or italic formatting. The default value is <code>FontAttributes.None</code>.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_FontFamily" aria-label="View FontFamily property in API reference">FontFamily</a></td>
    ...
    <td>Specifies the font family used to render the tooltip text.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_FontSize" aria-label="View FontSize property in API reference">FontSize</a></td>
    ...
    <td>Controls the size of the text displayed in the tooltip.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_Margin" aria-label="View Margin property in API reference">Margin</a></td>
    ...
    <td>Defines the spacing between the tooltip content and its outer boundary.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstTooltipSettings.html#Syncfusion_Maui_SunburstChart_SunburstTooltipSettings_TextColor" aria-label="View TextColor property in API reference">TextColor</a></td>
    ...
    <td>Controls the color used to render the tooltip text.</td>
</tr>
