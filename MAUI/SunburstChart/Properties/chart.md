---
layout: post
title: Chart in .NET MAUI Sunburst Chart | Syncfusion®
description: This section lists the public API members of the SfSunburstChart control available in the Syncfusion® .NET MAUI Sunburst Chart API.
platform: maui
...
<tr valign="top">
    ...
    <td>Controls how long chart animations take to complete.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Provides the size of the chart's center hole, which can be used when sizing content displayed in the center of the sunburst chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Displays custom content, such as text, images, or other views, in the center of the sunburst chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Configures the appearance and behavior of data labels displayed on chart segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls whether animations are played when the sunburst chart is rendered or updated. The default value is <code>false</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Controls whether users can navigate deeper into the hierarchy by selecting chart segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Applies the Liquid Glass visual effect to the chart when supported by the platform. Supported on iOS and macOS. The default value is <code>false</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Controls whether tooltips are displayed when users interact with chart segments. The default value is <code>false</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Defines the ending angle of the sunburst chart, allowing partial or full circular layouts. The default value is <code>360</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the size of the empty space at the center of the chart as a proportion of the chart radius. Value must be between 0 and 1. The default value is <code>0.25</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Specifies the collection of data items used to generate the sunburst chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Configures the legend displayed for the sunburst chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Defines the hierarchical levels used to organize and render the sunburst chart structure.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Specifies the collection of brushes used to color chart segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the overall size of the sunburst chart relative to the available plot area. The default value is <code>0.9</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Configures the appearance and behavior of segment selection.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Controls whether data labels are displayed on chart segments. The default value is <code>false</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Defines the angle at which the sunburst chart begins rendering. The default value is <code>0</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the brush used to draw segment outlines. The default value is <code>White</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the thickness of segment outlines. The default value is <code>1</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.object" aria-label="View object type in API reference">object</a></td>
    <td>Displays a title for the sunburst chart using either text or a custom view.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Configures the appearance and positioning of the drill-down toolbar.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Configures the appearance and behavior of chart tooltips.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Specifies a custom template used to define the content and appearance of tooltips.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Specifies the data field that provides the values used to size the chart segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler type in API reference">EventHandler&lt;</a><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstSelectionChangingEventArgs.html" aria-label="View SunburstSelectionChangingEventArgs type in API reference">SunburstSelectionChangingEventArgs</a><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler type in API reference">&gt;</a></td>
    <td>Triggered before a selection change is applied, allowing the pending selection to be validated or canceled.</td>
</tr>
</table>
