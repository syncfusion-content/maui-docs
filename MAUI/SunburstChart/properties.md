...
<td>Defines the duration of the chart animation in milliseconds and controls how long the segment transition takes when the chart is rendered or updated.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the size of the center hole in the chart and controls how much space is left open at the middle of the sunburst layout.</td>
</tr>
...
<td>Defines the custom view displayed at the center of the chart and allows supplemental content to be placed inside the hollow area.</td>
</tr>
...
<td>Defines the settings used to display data labels and controls how labels are positioned, styled, and shown across the radial segments.</td>
</tr>
...
<td>Determines whether animation is enabled and controls whether chart segments animate when the visual state changes.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether drill-down is enabled and allows deeper hierarchy levels to be explored through segment interaction.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the <code>liquid glass</code> effect is enabled and applies a translucent visual treatment to the chart surface.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether tooltips are displayed and controls whether segment details appear on hover or tap interaction.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the ending angle of the chart and controls the final angular position used to render the sunburst layout.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the inner radius of the chart and controls how large the hollow center is relative to the overall chart size.</td>
</tr>
...
<td>Defines the data source used to populate the chart and supplies the hierarchical collection that is transformed into radial segments.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.ChartLegend.html" aria-label="View ChartLegend type in API reference">ChartLegend</a></td>
<td>Defines the legend displayed in the chart and controls how segment categories are presented alongside the visualization.</td>
</tr>
...
<td>Defines the collection of hierarchical levels displayed in the chart and controls how each ring maps to the configured data hierarchy.</td>
</tr>
...
<td>Defines the collection of brushes used to render chart segments and supplies the visual palette applied across the radial slices.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the outer radius of the chart and controls the total radial extent of the sunburst visualization.</td>
</tr>
...
<td>Defines the settings used for segment selection and controls the visual response applied to the selected chart elements.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether data labels are displayed and controls the visibility of segment captions in the chart.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the starting angle of the chart and controls the angular position at which the first segment begins.</td>
</tr>
...
<td>Defines the border brush used for chart segments and controls the outline color drawn around each radial slice.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the border width of chart segments and controls the thickness of the outline surrounding each slice.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.ChartTitle.html" aria-label="View ChartTitle type in API reference">ChartTitle</a></td>
<td>Defines the title displayed in the chart and provides the header content used to describe the visualization.</td>
</tr>
...
<td>Defines the settings used to configure the toolbar and controls how chart actions are exposed through the toolbar surface.</td>
</tr>
...
<td>Defines the settings used to display tooltips and controls the interaction, placement, and styling of tooltip content.</td>
</tr>
...
<td>Defines the template used to display tooltips and allows custom presentation of the content shown for selected segments.</td>
</tr>

<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SfSunburstChart.html#Syncfusion_Maui_SunburstChart_SfSunburstChart_ValuePath" aria-label="View ValuePath property in API reference">ValuePath</a></td>
<td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Defines the property path used to map values and identifies the source field that supplies segment values for the chart.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstSelectionChangedEventArgs.html" aria-label="View SunburstSelectionChangedEventArgs type in API reference">SunburstSelectionChangedEventArgs</a></td>
<td>Raised when the selected sunburst segment changes and provides the details associated with the final selection state.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.SunburstChart.SunburstSelectionChangingEventArgs.html" aria-label="View SunburstSelectionChangingEventArgs type in API reference">SunburstSelectionChangingEventArgs</a></td>
<td>Raised before the selected sunburst segment changes and provides the details needed to inspect or adjust the pending selection update.</td>
</tr>
