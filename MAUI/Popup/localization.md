...
To localize the `Popup` based on the `CurrentUICulture` using the `resource` files, follow these steps.
   ...
   ![shows-the-name-of-resource-file-to-be-added-for-syncfusion-.net-maui-popup](Images/localization/shows-the-name-of-resource-file-to-be-added-for-maui-popup.png)

   5. Now, select `Add` option to add the resource file in the **Resources** folder.

   ![shows-the-added-resource-file-for-french-language-in-syncfusion-.net-maui-popup](Images/localization/shows-the-added-resource-file-for-french-language-in-maui-popup.png)
   ...
   ![shows-the-added-resource-file-name-value-pair-in-the-resource-designer-in-syncfusion-.net-maui-popup](Images/localization/shows-the-added-resource-file-name-value-pair-in-the-resource-designer-in-maui-popup.png)