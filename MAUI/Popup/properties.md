...
<td>Defines the absolute X-coordinate used to place the popup on the screen and controls horizontal positioning with pixel-level precision.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the absolute Y-coordinate used to place the popup on the screen and controls vertical positioning with pixel-level precision.</td>
</tr>
...
<td>Defines the text displayed on the accept action button and provides the confirmation label shown in the popup footer.</td>
</tr>
...
<td>Defines the command executed when the accept action is invoked and connects the confirmation action to application logic.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the time taken, in milliseconds, for the popup animation and controls how quickly the popup opens or closes.</td>
</tr>
...
<td>Defines the easing function used for popup animations and shapes the motion curve applied during open and close transitions.</td>
</tr>
...
<td>Defines the animation mode used when opening or closing the popup by using the <code>PopupAnimationMode</code> enum.</td>
</tr>
...
<td>Defines the visual appearance mode of the popup content surface by using the <code>PopupButtonAppearanceMode</code> enum.</td>
</tr>
...
<td>Defines the time interval after which the popup closes automatically and controls the lifetime of transient popup content.</td>
</tr>
...
<td>Defines how the popup size is calculated automatically by using the <code>PopupAutoSizeMode</code> enum and controls whether the popup adapts to content or container constraints.</td>
</tr>
...
<td>Defines the target used for popup auto-sizing by using the <code>PopupAutoSizeTarget</code> enum and controls which area is measured for automatic layout.</td>
</tr>
...
<td>Defines the template used to display popup content and enables fully customized layouts for the main popup body.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Defines the text displayed on the decline action button and provides the cancellation label shown in the popup footer.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.windows.input.icommand" aria-label="View ICommand type in API reference">ICommand</a></td>
<td>Defines the command executed when the decline action is invoked and connects the cancellation action to application logic.</td>
</tr>
...
<td>Determines whether the <code>liquid glass</code> visual effect is enabled and applies a refined translucent styling to the popup surface.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the height of the popup footer and controls the vertical space reserved for action content.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.datatemplate" aria-label="View DataTemplate type in API reference">DataTemplate</a></td>
<td>Defines the template used to display the popup footer and enables custom button or summary layouts in the footer area.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the height of the popup header and controls the vertical area reserved for the title region.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.datatemplate" aria-label="View DataTemplate type in API reference">DataTemplate</a></td>
<td>Defines the template used to display the popup header and enables custom title or branding layouts.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Defines the title displayed in the popup header and provides the main heading for the popup content.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the action bar area is ignored when displaying the popup and controls how the popup is measured against the top application chrome.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the popup occupies the full screen and expands the popup surface to cover the available display area.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the popup is currently open and reflects the visible state of the control.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Defines the message displayed in the popup and provides the primary body text shown to communicate content or status.</td>
</tr>
...
<td>Defines the overlay mode displayed behind the popup by using the <code>PopupOverlayMode</code> enum and controls how the background is dimmed or blocked.</td>
</tr>
...
<td>Defines the padding applied to the popup content and controls the inner spacing around the displayed elements.</td>
</tr>
...
<td>Defines the visual styling applied to the popup and provides the styling object used to tune borders, colors, and layout-related appearance.</td>
</tr>
...
<td>Defines the popup position relative to another view by using the <code>PopupRelativePosition</code> enum and controls how the popup is aligned to its anchor.</td>
</tr>
...
<td>Defines the view used as the anchor for relative placement and establishes the reference element for popup positioning.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the close button is displayed and controls the visibility of the popup dismissal control.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the popup footer is displayed and controls the visibility of the action area at the bottom of the popup.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the popup header is displayed and controls the visibility of the title region.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the overlay remains visible at all times and keeps the background mask active while the popup is shown.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the X-coordinate from which the popup animation starts and controls the initial horizontal position during display.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the Y-coordinate from which the popup animation starts and controls the initial vertical position during display.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether the popup remains open until it is explicitly closed and prevents automatic dismissal.</td>
</tr>
</table>
...
<td>Closes the popup and ends the current presentation without returning a value.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Refreshes the popup layout and appearance and reapplies the current visual state.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays the popup with the specified animation behavior and uses the provided flag to control animated presentation.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays the popup at the specified coordinates and positions the popup using explicit X and Y values.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays a popup with a title, message, and auto-close duration and provides a quick way to show temporary content.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays a popup with a title, message, accept button text, and auto-close duration and supports a confirmation-oriented layout.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays a popup with a title, message, accept button text, decline button text, and auto-close duration and supports a complete action footer.</td>
</tr>
...
<td>Displays the popup asynchronously and returns a task that completes when the operation finishes.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
<td>Displays the popup relative to the specified view and position and anchors the popup to a target control with optional offset values.</td>
</tr>
</table>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1?view=net-10.0" aria-label="View EventHandler<TEventArgs> type in API reference">EventHandler<TEventArgs></a></td>
<td>Raised after the popup closes and provides the final closing state for post-close handling.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1?view=net-10.0" aria-label="View PopupClosingEventArgs type in API reference">EventHandler<TEventArgs></a></td>
<td>Raised before the popup closes and allows inspection of the pending close operation.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1?view=net-10.0" aria-label="View PopupOpenedEventArgs type in API reference">EventHandler<TEventArgs></a></td>
<td>Raised after the popup opens and signals that the popup content is fully visible.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1?view=net-10.0" aria-label="View PopupOpeningEventArgs type in API reference">EventHandler<TEventArgs></a></td>
<td>Raised before the popup opens and provides a point for preparation or cancellation logic.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Popup.PopupPositionChangingEventArgs.html" aria-label="View PopupPositionChangingEventArgs type in API reference">PopupPositionChangingEventArgs</a></td>
<td>Raised when the popup position is changing and exposes the pending placement update for validation or adjustment.</td>
</tr>
</table>