...
<table>
    ...
    <tr valign="top">
        ...
        <td>Defines the <code>custom</code> icon for the action button.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>position</code> of the action button in the input view.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the collection of <code>action buttons</code> shown in the editor view.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>type</code> of the action button displayed in the input view.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the collection of available <code>agents</code>.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines whether <code>full-screen</code> editor mode is enabled.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
        <td>Defines whether <code>multiple</code> files can be picked.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>Defines the <code>empty state</code> content when no conversations exist.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View string type in API reference">string</a></td>
        <td>Defines the <code>global</code> system prompt applied to conversations.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.datatemplate" aria-label="View DataTemplate type in API reference">DataTemplate</a></td>
        <td>Defines the <code>custom</code> template for the temporary chat banner.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.datatemplate" aria-label="View DataTemplate type in API reference">DataTemplate</a></td>
        <td>Defines the template used to display <code>custom</code> content in the time break area.</td>
    </tr>
    <tr valign="top">
