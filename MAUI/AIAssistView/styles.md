---
layout: post
title: Styles in .NET MAUI AI Assist View control | Syncfusion
description: Learn here all about Styles support in Syncfusion .NET MAUI AI Assist View (SfAIAssistView) control, its elements, and more.
platform: MAUI
control: SfAIAssistView
documentation: ug
---

# Styles in .NET MAUI AI Assist View (SfAIAssistView)

You can style the elements of the `SfAIAssistView` control by creating resource dictionaries and assigning values to the in-built keys assigned for each individual element.
