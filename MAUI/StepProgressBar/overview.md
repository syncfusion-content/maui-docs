...
description: Learn about the Syncfusion® .NET MAUI Step ProgressBar (SfStepProgressBar) control, its basic features, and functionalities.
platform: maui
...
![Overview of .NET MAUI StepProgressBar (SfStepProgressBar)](images/overview/maui-stepprogressbar-overview.gif)
...
<a href="https://www.syncfusion.com/maui-controls/maui-stepprogressbar" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/step-progress-bar" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/1414" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
