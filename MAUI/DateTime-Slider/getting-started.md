---
layout: post
title: Getting Started with .NET MAUI DateTime Slider | Syncfusion®
description: Learn how to get started with the Syncfusion® .NET MAUI DateTime Slider control. Explore setup, features, examples, and customization options.
platform: maui
