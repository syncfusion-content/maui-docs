---
layout: post
title: Getting started with .NET MAUI Slider control | Syncfusion<sup>®</sup>
description: This section explains about the getting started with Syncfusion<sup>®</sup> MAUI Slider (SfDateTimeSlider) control and more.
platform: maui
