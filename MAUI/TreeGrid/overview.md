---
layout: post
title: About Syncfusion .NET MAUI Tree Grid control | Syncfusion®
description: Learn about introduction of Syncfusion® Essential Studio .NET MAUI Tree Grid control and more details.
platform: MAUI
control: SfTreeGrid
documentation: ug
