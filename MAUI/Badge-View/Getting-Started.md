---
layout: post
title: Getting Started with .NET MAUI Badge View | Syncfusion®
description: Learn how to get started with the Syncfusion® .NET MAUI Badge View control. Explore setup, features, examples, and customization options.
platform: MAUI
control: SfBadgeView
documentation: UG
---
...
Use the [ScreenReaderText](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Core.SfBadgeView.html#Syncfusion_Maui_Core_SfBadgeView_ScreenReaderText) property to specify text that screen readers announce for the Badge View.

An image, button, label or any view can be added to the Badge View using the [Content](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Core.SfBadgeView.html#Syncfusion_Maui_Core_SfBadgeView_Content) property. If you need to display a custom icon or image in the Badge View, ensure the image is included correctly in your project resources.
