...
| SfBorder | Syncfusion.Xamarin.Core | Obsolete. Use [Border](https://learn.microsoft.com/dotnet/maui/user-interface/controls/border) | – |
...
| SfGradientView | Syncfusion.Xamarin.Core | Obsolete. Use [Gradients](https://learn.microsoft.com/dotnet/maui/user-interface/brushes/gradient) | – |
...
* **SfBorder** - Use the [.NET MAUI Border](https://learn.microsoft.com/dotnet/maui/user-interface/controls/border) element.
* **SfGradientView** - Use [.NET MAUI Gradients](https://learn.microsoft.com/dotnet/maui/user-interface/brushes/gradient) (**LinearGradientBrush**, **RadialGradientBrush**).
