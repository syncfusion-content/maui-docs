...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler type in API reference">EventHandler&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.textchangedeventargs" aria-label="View TextChangedEventArgs type in API reference">TextChangedEventArgs&gt;</a></a></td>
