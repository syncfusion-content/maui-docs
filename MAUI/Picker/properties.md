---
layout: post
title: Properties of .NET MAUI Picker control | Syncfusion®
description: Learn about the properties and events of the Syncfusion .NET MAUI Picker control, including customization and behavior settings.
platform: maui
control: SfPicker
documentation: ug
---
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_ColumnHeaderView" aria-label="View ColumnHeaderView property in API reference">ColumnHeaderView</a></td>
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerColumnHeaderView.html" aria-label="View PickerColumnHeaderView type in API reference">PickerColumnHeaderView</a></td>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_Columns" aria-label="View Columns property in API reference">Columns</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.collections.objectmodel.observablecollection-1" aria-label="View ObservableCollection type in API reference">ObservableCollection&lt;<a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerColumn.html" aria-label="View PickerColumn type in API reference">PickerColumn&gt;</a></a></td>
    <td>Defines the collection of picker columns displayed in the control. Each column can provide its own items and item presentation.</td>
</tr>
<tr valign="top">
    ...
    <td>Applies a custom text style to items in the day column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td>Controls the width of the day column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_HeaderView" aria-label="View HeaderView property in API reference">HeaderView</a></td>
    ...
    <td>Customizes the appearance and content of the picker header.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the hour column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the hour column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Controls when a selection is committed in dialog and relative dialog modes. When enabled, changes are applied immediately as the user interacts with the picker; otherwise, confirmation through the OK button is required.</td>
</tr>
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_ItemTemplate" aria-label="View ItemTemplate property in API reference">ItemTemplate</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.datatemplate" aria-label="View DataTemplate type in API reference">DataTemplate</a></td>
    <td>Customizes how items are displayed within picker columns.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the AM/PM column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the AM/PM column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the millisecond column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the millisecond column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the minute column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the minute column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the month column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the month column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the second column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the second column. Available only in SfTimePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td>Customizes the visual appearance of the selection indicator displayed around the currently selected item.</td>
</tr>
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_SelectionChangedCommand" aria-label="View SelectionChangedCommand property in API reference">SelectionChangedCommand</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.windows.input.icommand" aria-label="View ICommand type in API reference">ICommand</a></td>
    <td>Runs when the selected item changes in the picker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Displays a close button in the picker header. The API documentation states that this property is not supported by SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td>Controls how item text is displayed when the available column width is insufficient, based on the selected display mode.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerTextStyle.html" aria-label="View PickerTextStyle type in API reference">PickerTextStyle</a></td>
    <td>Applies a custom text style to items in the year column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the width of the year column. Available only in SfDatePicker and SfDateTimePicker.</td>
</tr>
</table>
...
<tr valign="top">
    ...
    <td>Handles the Cancel button action when the user dismisses the picker without confirming the current selection.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View void type in API reference">void</a></td>
    <td>Responds to header button interactions and allows custom handling when a header button is selected.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View void type in API reference">void</a></td>
    <td>Handles the OK button action when the user confirms the current selection.</td>
</tr>
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View void type in API reference">void</a></td>
    <td>Provides an extension point while the picker is being initialized, such as when a popup is opening or when switching from popup mode to the default display mode.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td>Triggered after the user taps the Cancel button. This event is raised only when the picker footer is visible.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.eventhandler" aria-label="View EventHandler type in API reference">EventHandler</a></td>
    <td>Triggered after the user taps the OK button to confirm the current selection. This event is raised only when the footer and OK button are visible.</td>
</tr>
<tr valign="top">
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.SfPicker.html#Syncfusion_Maui_Picker_SfPicker_SelectionChanged" aria-label="View SelectionChanged event in API reference">SelectionChanged</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.eventhandler" aria-label="View EventHandler type in API reference">EventHandler&lt;<a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Picker.PickerSelectionChangedEventArgs.html" aria-label="View PickerSelectionChangedEventArgs type in API reference">PickerSelectionChangedEventArgs&gt;</a></a></td>
    <td>Triggered when the selected item changes in the picker. Use this event to respond to selection updates.</td>
</tr>
</table>