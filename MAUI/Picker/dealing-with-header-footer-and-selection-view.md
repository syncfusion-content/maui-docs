...
description: Learn about header, footer, and selection views in the Syncfusion .NET MAUI Picker control, including customization and styling options.
platform: maui
control: SfPicker
documentation: ug
---

# Header, Footer, and Selection in .NET MAUI Picker control
