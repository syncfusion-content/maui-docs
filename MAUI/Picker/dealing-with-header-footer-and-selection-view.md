---
layout: post
title: Header and Footer in .NET MAUI Picker | Syncfusion
description: Learn how to customize header, footer, and selection views in .NET MAUI Picker control with various styling options.
platform: maui
control: SfPicker
documentation: ug
---
