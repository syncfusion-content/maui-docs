...
<tr valign="top">
    ...
    <td>Scaling behavior of the image within the view. Choose <code>AspectFit</code>, <code>AspectFill</code>, or <code>Fill</code> to control the layout.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Built-in vector avatar shown when the content type is <code>AvatarCharacter</code>. A predefined character is rendered.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Color mode for the avatar background. Use <code>Custom</code> or <code>Dark</code> to match the theme.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Name displayed as the avatar text. The initials or name is rendered in the view.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Shape of the avatar view. Choose <code>Circle</code>, <code>Square</code>, or <code>RoundedSquare</code> for the outline.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Size of the avatar view. Use <code>ExtraSmall</code>, <code>Small</code>, <code>Medium</code>, <code>Large</code>, or <code>ExtraLarge</code> to set the dimension.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Background brush of the avatar view. A <code>gradient</code> or <code>solid</code> brush can be applied.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Background color of the avatar view. A <code>solid</code> color fills the background.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Property path used to read the background color when the content type is <code>Group</code>. Each member supplies its color.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Space between the stroke and the content. Larger values add more padding inside the view.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Content type displayed in the avatar view. Choose <code>Initials</code>, <code>AvatarCharacter</code>, <code>Custom</code>, or <code>Group</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Corner radius of the avatar view. Larger values produce more rounded corners.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Font attributes for the initials when the content type is <code>Initials</code>. Use <code>Bold</code>, <code>Italic</code>, or <code>None</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Determines whether the font scales with the operating system settings. The text follows the device size.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Font family for the initials when the content type is <code>Initials</code>. The chosen font is applied to the text.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Font size for the initials string. Larger values produce bigger initials.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Collection used for group avatar views. Each item contributes to the grouped display.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Height of the avatar view. The view occupies the requested vertical space.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Custom image shown when the content type is <code>Custom</code>. The provided image is rendered in the view.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Property path used to read the image source when the content type is <code>Group</code>. Each member supplies its image.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
    <td>Color of the initials string. The chosen color is applied to the text.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Property path used to read the initials color when the content type is <code>Group</code>. Each member supplies its color.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Property path used to read the initials when the content type is <code>Group</code>. Each member supplies its initials.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Initials type shown in the avatar view. Choose <code>SingleCharacter</code> or <code>DoubleCharacter</code> for the text.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
    <td>Stroke brush of the avatar view. A <code>solid</code> or <code>gradient</code> brush outlines the view.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Thickness of the stroke around the avatar view. Larger values produce a thicker outline.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Width of the avatar view. The view occupies the requested horizontal space.</td>
</tr>
