...
<tr valign="top">
	...
	<td>Background brush of the avatar view. A gradient or solid brush can be applied.</td>
</tr>
...
<tr valign="top">
	...
	<td>Background color of the avatar view. A solid color fills the background.</td>
</tr>
...
<tr valign="top">
	...
	<td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
	<td>Stroke brush of the avatar view. A solid or gradient brush outlines the view.</td>
</tr>
