...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.threading.tasks.task-1" aria-label="View Task&lt;Stream&gt; type in API reference">Task&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.io.stream" aria-label="View Stream type in API reference">Stream&gt;</a></a></td>
