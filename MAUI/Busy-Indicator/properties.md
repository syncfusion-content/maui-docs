...
<tr valign="top">
    ...
    <td>Animation style used by the busy indicator. Choose a supported <code>AnimationType</code> value to control how the loading effect appears.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Multiplier used to adjust the animation duration. Larger values slow down the loading motion, while smaller values speed it up.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Font styling applied to the title text. Use it to make the title <code>bold</code>, <code>italic</code>, or <code>plain</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Determines whether the title text follows the device font scaling settings for accessibility.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Font family used for the title text. The selected font is applied to the label shown with the indicator.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Font size used for the title text. Larger values make the title more prominent.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Color used to draw the busy indicator. A clear contrast helps the loading animation stand out.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
    <td>Determines whether the busy indicator animation is active. Set it to <code>true</code> to show the loading state.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Brush shown behind the indicator. A solid or gradient fill can be used to create the overlay background.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Scale factor used to change the size of the indicator. Larger values make the loading animation bigger.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
    <td>Color used for the title text. The chosen color is applied to the label shown with the indicator.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Text shown with the busy indicator. It is typically used to describe the current loading state.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Placement of the title relative to the indicator. Choose a supported <code>BusyIndicatorTitlePlacement</code> value to position the text correctly.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Spacing between the title and the indicator. Larger values increase the distance between both elements.</td>
</tr>
</table>
...
<tr valign="top">
    ...
    <td>Called when the title font changes. This method updates the busy indicator text font from the old value to the new value.</td>
</tr>
</table>
