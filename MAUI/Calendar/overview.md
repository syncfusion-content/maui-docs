...
* **Date selection**: Date selection allows you to select the Single date, Multiple dates, Range of dates or a Multiple range of dates by interaction or programmatic selection.
