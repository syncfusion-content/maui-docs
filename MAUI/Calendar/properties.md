...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.func-2" aria-label="View Func type in API reference">Func&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.datetime" aria-label="View DateTime type in API reference">DateTime</a>, <a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool&gt;</a></a></td>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.nullable" aria-label="View Nullable type in API reference">Nullable&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.datetime" aria-label="View DateTime type in API reference">DateTime&gt;</a></a></td>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.collections.objectmodel.observablecollection-1" aria-label="View ObservableCollection type in API reference">ObservableCollection&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.datetime" aria-label="View DateTime type in API reference">DateTime&gt;</a></a></td>
