---
layout: post
title: Thumb and Overlay in .NET MAUI Range Selector | Syncfusion®
description: Learn how to customize thumbs and overlays in the Syncfusion® .NET MAUI Range Selector (SfRangeSelector) control.
platform: maui
