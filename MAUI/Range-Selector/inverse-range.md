...
description: Learn here all about the Inverse feature of Syncfusion® .NET MAUI Range Selector (SfRangeSelector) control and more.
platform: maui
control: SfRangeSelector
documentation: ug
---

# Inverting the Range Selector
