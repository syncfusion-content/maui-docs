...
control: SfDataPager
documentation: UG
keywords : maui datapager, datapager customization, datapager style, customize appearance, .net maui datapager
---
...
<img alt="DataPager style .NET MAUI DataPager." src="Images\customization\net-maui-datapager-style.png" width="404"/>
