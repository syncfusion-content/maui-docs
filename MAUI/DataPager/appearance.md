...
control: SfDataPager
documentation: UG
keywords : maui datapager, datapager appearance, button shape, button size, display mode, .net maui datapager
---
...
<img alt="Numeric button shape .NET MAUI DataPager." src="Images\appearance\net-maui-datapager-button-shape.png" width="404"/>
...
<img alt="Button size and font size of .NET MAUI DataPager." src="Images\appearance\net-maui-datapager-buttonsize-and-fontsize.png" width="404"/>
...
<img alt="Auto-ellipsis mode .NET MAUI DataPager." src="Images\appearance\net-maui-datapager-autoelipsismode.png" width="404"/>
