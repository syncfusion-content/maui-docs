...
<a href="https://help.syncfusion.com/maui/button/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              The .NET MAUI custom Button is a UI lets users set icons, background images, and corner edge radii and customize its appearance for different visual states using the visual state manager.
</div>
</div>
</div>
<!-- Card 2 -->
...
<a href="https://help.syncfusion.com/maui/checkbox/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<a href="https://help.syncfusion.com/maui/chips/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<a href="https://help.syncfusion.com/maui/radio-button/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<a href="https://help.syncfusion.com/maui/segmented-control/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<a href="https://help.syncfusion.com/maui/switch/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                The .NET MAUI Switch allows you to turn an item on and off and provides an optional indeterminate state. It also supports the VSM.
</div>
</div>
</div>
