...
description: Smart components and preview controls for AI-driven experiences.
platform: maui
control: AI & Smart Experiences
documentation: ug
---

# AI & Smart Experiences

This section groups intelligent and AI-augmented controls designed to simplify complex tasks and surface contextual suggestions. Use these components to add assistants, smart editing and predictive scheduling to your MAUI apps.
...
<h3 class="form-title">Smart DataGrid
...
<div class="form-content">
<h3 class="form-title">Smart Scheduler
...
<div class="form-content">
<h3 class="form-title">Smart Image Editor
