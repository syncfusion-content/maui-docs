...
<h3 class="form-title">Avatar View
<a href="https://help.syncfusion.com/maui/avatar-view/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-content">
<h3 class="form-title">Effects View
<a href="https://help.syncfusion.com/maui/effects-view/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-content">
<h3 class="form-title">Shimmer
<a href="https://help.syncfusion.com/maui/shimmer/overview"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
