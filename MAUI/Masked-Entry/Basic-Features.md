---
layout: post
title: Basic Features in .NET MAUI Masked Entry control | Syncfusion<sup>®</sup>
description: Learn about Basic Features support in Syncfusion<sup>®</sup> .NET MAUI Masked Entry (SfMaskedEntry) control and more.
platform: maui
