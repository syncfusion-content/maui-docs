...
- `ReturnCommand` : Specifies what should happent when a [SfMaskedEntry](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.SfMaskedEntry.html) is interacted (e.g., clicking a button or pressing Enter key in an entry field).
