---
layout: post
title: Getting Started with .NET MAUI Masked Entry | Syncfusion®
description: Learn how to get started with Syncfusion® .NET MAUI Masked Entry (SfMaskedEntry) control, its elements, and more.
platform: maui
control: MaskedEntry
documentation: ug 
