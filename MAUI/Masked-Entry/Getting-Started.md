---
layout: post
title: Getting Started with .NET MAUI Masked Entry control | Syncfusion<sup>®</sup>
description: Learn about getting started with Syncfusion<sup>®</sup> .NET MAUI Masked Entry (SfMaskedEntry) control, its elements, and more.
platform: maui
control: MaskedEntry
documentation: ug 
