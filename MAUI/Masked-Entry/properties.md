...
<table>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.shapes.path?view=net-maui-10.0" aria-label="View Path type in API reference">Path</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.keyboard?view=net-maui-10.0" aria-label="View Keyboard type in API reference">Keyboard</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.char" aria-label="View Char type in API reference">char</a></td>
