...
<table>
    ...
    <tr valign="top">
        ...
        <td>Defines the <code>Color</code> used for the clear button icon and controls its visible appearance.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>Path</code> used to draw the clear button icon. This enables a custom icon shape instead of the default visual.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines when the clear button is displayed. Use the <code>ClearButtonVisibility</code> enum to control whether it appears always, while editing, or never.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>CultureInfo</code> used to format and parse the masked value according to regional settings.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the current cursor position inside the text. This helps place the insertion point at a specific location during editing.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Determines whether the font size scales automatically with system accessibility text settings.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the font family used for the text. This controls the typeface shown in the control.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the font size used for the text. Larger values increase readability, while smaller values save space.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the complete <code>Font</code> used for the control text, including typeface and size settings.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Indicates whether the current value is invalid. This is useful for applying validation feedback and error styling.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether prompt characters are hidden when the control loses focus. This keeps the field compact after editing.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the horizontal alignment of the entered text. Use the <code>TextAlignment</code> enum to align text to <code>Start</code>, <code>Center</code>, or <code>End</code>.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether the value can be edited. When set to <code>true</code>, the content can be viewed but not changed.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the keyboard layout used for input. This controls the input mode shown on the device, such as numeric or email entry.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
        <td>Defines the mask pattern applied to the text. This pattern controls which characters can be entered and how the value is formatted.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines how the mask is interpreted. The <code>MaskedEntryMaskType</code> enum controls the masking behavior applied to the input.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the character used to mask entered text. This is commonly used to hide sensitive input while preserving text length.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.int32" aria-label="View Int32 type in API reference">int</a></td>
        <td>Defines the delay before the last typed character is masked again. This briefly reveals the latest character for easier entry confirmation.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
        <td>Defines the placeholder text displayed when the control is empty. This gives a clear hint about the expected input.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
        <td>Defines the <code>Color</code> used for the placeholder text. This helps distinguish placeholder text from entered content.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.char" aria-label="View Char type in API reference">char</a></td>
        <td>Defines the character used to represent empty mask positions. This gives a visible structure for unfilled input slots.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the command executed when the return key is pressed. This enables keyboard submission behavior to be handled in application logic.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the parameter passed to the return command. This value is forwarded when the return action is executed.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.returntype" aria-label="View ReturnType enum in API reference">ReturnType</a></td>
        <td>Defines the return key behavior for the keyboard. Use the <code>ReturnType</code> enum to control labels such as <code>Done</code>, <code>Go</code>, <code>Next</code>, or <code>Search</code>.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether all text is selected automatically when the control receives focus. This is useful for quick replacement of the current value.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>Brush</code> used for the control border. This can be a solid color, gradient, or other supported brush style.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
        <td>Defines the current text entered in the control. This reflects the visible content after masking and formatting rules are applied.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
        <td>Defines the <code>Color</code> used for the entered text. This helps control contrast and readability.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines when validation is performed. Use the <code>InputValidationMode</code> enum to control whether validation occurs while typing or after focus changes.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.object" aria-label="View Object type in API reference">object</a></td>
        <td>Defines the masked value represented by the control. This is the underlying value exposed after mask processing.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines how the masked value is returned. The <code>MaskedEntryMaskFormat</code> enum controls whether literals and prompt characters are included or omitted.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.textalignment" aria-label="View TextAlignment type in API reference">TextAlignment</a></td>
        <td>Defines the vertical alignment of the entered text. Use the <code>TextAlignment</code> enum to align content to <code>Start</code>, <code>Center</code>, or <code>End</code>.</td>
    </tr>
</table>
...
<table>
    ...
    <tr valign="top">
        ...
        <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.MaskedEntryValueChangedEventArgs.html" aria-label="View MaskedEntryValueChangedEventArgs type in API reference">MaskedEntryValueChangedEventArgs</a></td>
        <td>Raised when the value changes after the control has accepted the updated input.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.MaskedEntryValueChangingEventArgs.html" aria-label="View MaskedEntryValueChangingEventArgs type in API reference">MaskedEntryValueChangingEventArgs</a></td>
        <td>Raised before the value is updated. This allows the pending change to be inspected before it is committed.</td>
    </tr>
</table>
...
<table>
    ...
    <tr valign="top">
        ...
        <td>Moves focus to the masked entry control. This is useful when editing must begin programmatically.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.void" aria-label="View Void type in API reference">void</a></td>
        <td>Removes focus from the masked entry control. This is useful when editing should be ended from code.</td>
    </tr>
</table>