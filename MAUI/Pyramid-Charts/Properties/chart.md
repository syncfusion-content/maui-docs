...
<tr valign="top">
    ...
    <td>Applies the <code>Liquid Glass</code> effect to the chart on iOS and macOS. Supported on iOS 26 or later and macOS 26 or later with .NET 10 or later; unsupported configurations use the standard background.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Customizes the <code>appearance</code>, <code>position</code>, and <code>formatting</code> of the data labels displayed on the pyramid segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Displays a <code>tooltip</code> when tapping or hovering over a pyramid segment to show its details.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the <code>spacing</code> between adjacent pyramid segments as a fraction of the segment height, where <code>0</code> means no gap and <code>1</code> means maximum gap.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Overrides the default <code>touch interactions</code>, such as tap and long-press, to implement custom behaviors on the chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Binds a <code>collection of data objects</code> to the chart, where each item defines a pyramid segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Displays a <code>legend</code> that helps identify each pyramid segment by its label or value.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Determines the <code>shape</code> of the icon displayed next to the pyramid item in the legend.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Determines how segment sizes are calculated. Use <code>Linear</code> so segment widths are proportional to their values, or <code>Surface</code> so widths are proportional to the <code>square root</code> of the values, giving smaller values better visibility.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Arranges the pyramid either <code>vertically</code>, flowing from top to bottom, or <code>horizontally</code>, flowing from left to right.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Applies a <code>sequence of brushes</code> to the pyramid segments, cycling through the list for each segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Places a <code>custom view</code> behind the chart plot area, allowing background elements like images or gradients to be displayed.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Maps a <code>property</code> from the data source to a brush value, assigning an <code>individual color</code> to each pyramid segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Enables <code>selecting</code> or <code>highlighting</code> one or more pyramid segments when tapped.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.graphics.rect" aria-label="View Rect type in API reference">Rect</a></td>
    <td>Retrieves the <code>actual rendering bounds</code> of the chart area used for drawing the pyramid series.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Displays the <code>data labels</code> on the pyramid segments.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Paints the <code>outline</code> of each pyramid segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Specifies the <code>thickness</code> of the outline drawn around each pyramid segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.object" aria-label="View object type in API reference">object</a></td>
    <td>Displays a <code>title</code> at the top of the chart, accepting either a string or a custom view.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Customizes the default <code>appearance</code>, such as <code>background</code> and <code>font</code>, of the tooltip shown on chart interaction.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.string" aria-label="View string type in API reference">string</a></td>
    <td>Maps a <code>property</code> from the data source to the <code>label</code> or <code>category</code> displayed for each pyramid segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.string" aria-label="View string type in API reference">string</a></td>
    <td>Maps a <code>property</code> from the data source to the <code>numeric value</code> that determines the size of each pyramid segment.</td>
</tr>
</table>
...
<tr valign="top">
    ...
    <td>Saves the current chart view as an <code>image file</code> in the device's <code>Pictures</code> or <code>Photos</code> folder. The filename extension determines whether the format is <code>JPEG</code> or <code>PNG</code>, and the chart view must be added to the visual tree.</td>
</tr>
</table>
