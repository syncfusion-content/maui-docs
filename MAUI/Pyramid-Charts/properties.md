...
<td>Defines the settings used to display data labels and controls how label content, placement, and presentation are applied to pyramid segments.</td>
</tr>
...
<td>Determines whether tooltips are displayed and controls whether segment details appear during interaction.</td>
</tr>
...
<td>Defines the gap ratio between pyramid segments and controls the spacing used to separate adjacent sections of the chart.</td>
</tr>
...
<td>Defines the data source used to populate the pyramid chart and supplies the collection transformed into chart segments.</td>
</tr>
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SfPyramidChart.html#Syncfusion_Maui_Charts_SfPyramidChart_LegendIcon" aria-label="View ChartLegendIconType enum in API reference">LegendIcon</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartLegendIconType.html" aria-label="View LegendIcon property in API reference">ChartLegendIconType</a></td>
<td>Defines the icon displayed for chart items in the legend by using the <code>ChartLegendIconType</code> enum.</td>
</tr>

<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SfPyramidChart.html#Syncfusion_Maui_Charts_SfPyramidChart_Mode" aria-label="View PyramidMode enum in API reference">Mode</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.PyramidMode.html" aria-label="View Mode property in API reference">PyramidMode</a></td>
<td>Defines the calculation mode used to render the pyramid chart by using the <code>PyramidMode</code> enum.</td>
</tr>

<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SfPyramidChart.html#Syncfusion_Maui_Charts_SfPyramidChart_Orientation" aria-label="View ChartOrientation enum in API reference">Orientation</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartOrientation.html" aria-label="View Orientation property in API reference">ChartOrientation</a></td>
<td>Defines the orientation of the pyramid chart by using the <code>ChartOrientation</code> enum and controls whether the pyramid is drawn vertically or horizontally.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">IList&lt;Brush&gt;</a></a></td>
<td>Defines the collection of brushes used to render chart segments and supplies the palette applied across the pyramid layers.</td>
</tr>
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartSelectionBehavior.html" aria-label="View ChartSelectionBehavior type in API reference">SelectionBehavior</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SfPyramidChart.html#Syncfusion_Maui_Charts_SfPyramidChart_SelectionBehavior" aria-label="View SelectionBehavior property in API reference">ChartSelectionBehavior</a></td>
<td>Defines the selection behavior applied to chart segments and controls how selected slices are highlighted and tracked.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Determines whether data labels are displayed and controls the visibility of label text on each segment.</td>
</tr>
...
<td>Defines the border brush used for chart segments and controls the outline color drawn around each section.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Defines the border width of chart segments and controls the thickness of the outline around each pyramid slice.</td>
</tr>
