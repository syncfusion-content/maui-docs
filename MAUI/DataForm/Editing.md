...
An editor can be disabled using the [EditableAttribute](https://learn.microsoft.com/dotnet/api/system.componentmodel.dataannotations.editableattribute) and [ReadOnlyAttribute](https://learn.microsoft.com/dotnet/api/system.componentmodel.readonlyattribute).
