...
<td>{{'[DataFormTextSearchMode]'| markdownify }}</td>
...
<td>{{'[GenerateDataFormItemEventArgs]'| markdownify }}</td>
...
<td>{{'[DataFormCommitMode]'| markdownify }}</td>
...
<td>{{'[DataFormValueConverterAttribute]'| markdownify }}</td>
...
<td>{{'[DataFormAutoCompleteItem]'| markdownify }}</td>
...
<td>{{'[DataFormCheckBoxItem]'| markdownify }}</td>
...
<td>{{'[DataFormDateItem]'| markdownify }}</td>
...
<td>{{'[DataFormComboBoxItem]'| markdownify }}</td>
...
<td>{{'[DataFormGroupItem]'| markdownify }}</td>
...
<td>{{'[DataFormItem]'| markdownify }}</td>
...
<td>{{'[DataFormViewItem]'| markdownify }}</td>
...
<td>{{'[DataFormPickerItem]'| markdownify }}</td>
...
<td>{{'[DataFormRadioGroupItem]'| markdownify }}</td>
...
<td>{{'[DataFormTextItem]'| markdownify }}</td>
...
<td>{{'[DataFormTimeItem]'| markdownify }}</td>
...
<td>{{'[DataFormDateRangeAttribute]'| markdownify }}</td>
...
<td>{{'[DataFormDisplayOptionsAttribute]'| markdownify }}</td>
...
<td>{{'[IDataFormSourceProvider]'| markdownify }}</td>
...
<td>{{'[DataFormTextStyle]'| markdownify }}</td>
...
<td>{{'[DataFormValidateFormEventArgs]'| markdownify }}</td>
...
<td>{{'[DataFormValidationMode]'| markdownify }}</td>
...
<td>{{'[ValidationMode]'| markdownify }}</td>
...
<td>{{'[ItemsSourceProvider]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[LabelTextStyle]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[ErrorLabelTextStyle]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[ValidMessageLabelTextStyle]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[DefaultLayoutSettings]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[ItemsOrderInRow]'| markdownify }}</td>
...
<td>{{'[LeadingLabelIcon]'| markdownify }}</td>
...
<td>{{'[PropertyInfo]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[ItemsPadding]'| markdownify }}</td>
...
<td>{{'[SelectedValuePath]'| markdownify }}</td>
...
<td>{{'[ValidMessage]'| markdownify }}</td>
...
<tr>
<td>Nil</td>
<td>{{'[DisplayFormat]'| markdownify }}</td>
...
<td>{{'[ConverterType]'| markdownify }}</td>
...
<td>{{'[GenerateDataFormItem]'| markdownify }}</td>
...
<td>{{'[ValidateProperty]'| markdownify }}</td>
...
<td>{{'[ValidateForm]'| markdownify }}</td>
...
<td>{{'[UpdateEditor]'| markdownify }}</td>
