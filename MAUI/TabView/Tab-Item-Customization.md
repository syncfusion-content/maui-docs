---
layout: post
title: Display Type in .NET MAUI Tab View (SfTabView) control | Syncfusion<sup>®</sup>
description: Learn here all about color and font customization in Syncfusion<sup>®</sup> .NET MAUI Tab View (SfTabView) control.
platform: maui
control: Tab View
documentation: ug
---
