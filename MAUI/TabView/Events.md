...
Before using the events documented here, ensure that the [Syncfusion .NET MAUI Tab View](https://help.syncfusion.com/maui/tabview/getting-started) package is installed and the `SfTabView` handler is registered in your `MauiProgram.cs`.
