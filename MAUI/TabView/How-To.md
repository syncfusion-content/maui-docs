---
layout: post
title: How to Select a Tab in .NET MAUI Tab View | Syncfusion®
...
This section explains how to programmatically select a tab item and how to detect or act on the currently selected tab item in the .NET MAUI Tab View control:
...
You can use the [SelectedIndex](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.TabView.SfTabView.html#Syncfusion_Maui_TabView_SfTabView_SelectedIndex) property of `Tab View` to programmatically select a tab item. The value is zero-based and must be less than the number of items in the `Items` collection.
...
<tabView:SfTabView x:Name="tabView" 
                   SelectionChanged="Index_Changed">
