---
layout: post
title: Visual state manager in .NET MAUI Tab View (SfTabView) | Syncfusion<sup>®</sup>
description: Learn here all about handling of visual state manager in Syncfusion<sup>®</sup> .NET MAUI Tab View (SfTabView) control and more.
platform: MAUI
control: TabView
documentation: ug
---
