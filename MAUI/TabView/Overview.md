...
<a href="https://www.syncfusion.com/maui-controls/maui-tab-view" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/TabView" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
