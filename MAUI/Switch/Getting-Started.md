...
description: Learn how to get started with the Syncfusion® .NET MAUI Switch (SfSwitch) control, its elements, and more.
platform: MAUI
control: SfSwitch
documentation: UG
...
![Getting Started with Switch](Images/getting-started/SfSwitch.png)
