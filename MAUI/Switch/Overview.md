...
- [Getting Started](https://help.syncfusion.com/maui/switch/getting-started) shows a step‑by‑step guide to begin using the Switch control.  
- [Customization](https://help.syncfusion.com/maui/switch/customization) explains how to customize appearance and themes.  
- [States](https://help.syncfusion.com/maui/switch/states) helps configure states and behavior.  
...
<a href="https://www.syncfusion.com/maui-controls/maui-switch" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/switch" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/1332" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
      Explore a real-world application that demonstrates the practical use of the Switch.
    </div>
