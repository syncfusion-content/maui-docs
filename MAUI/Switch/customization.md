---
layout: post
title: Customization in .NET MAUI Switch Control | Syncfusion<sup>®</sup>
description: Learn here all about Customization support in Syncfusion<sup>®</sup> .NET MAUI Switch (SfSwitch) control, and more.
platform: maui
control: SfSwitch
documentation: ug
