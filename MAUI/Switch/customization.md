...
* [TrackStroke](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_TrackStroke): Represents the `Color` value used for the border of the track.
* [ThumbStroke](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_ThumbStroke): Represents the `Color` value used for the border of the thumb.
...
onStyle.TrackBackground = new SolidColorBrush(Color.FromArgb("#FF029BFF"));
onStyle.ThumbBackground = new SolidColorBrush(Color.FromArgb("#FF029BFF"));
onStyle.TrackStroke = Color.FromArgb("#FF029BFF");
onStyle.ThumbStroke = Color.FromArgb("#FF029BFF");

SwitchSettings offStyle = new SwitchSettings();
offStyle.TrackBackground = new SolidColorBrush(Color.FromArgb("#22FF0199"));
offStyle.ThumbBackground = new SolidColorBrush(Color.FromArgb("#FFFF0199"));
offStyle.TrackStroke = Color.FromArgb("#FFFF0199");
offStyle.ThumbStroke = Color.FromArgb("#FFFF0199");

SwitchSettings indeterminateStyle = new SwitchSettings();
indeterminateStyle.TrackBackground = new SolidColorBrush(Color.FromArgb("#DEF991"));
indeterminateStyle.ThumbBackground = new SolidColorBrush(Color.FromArgb("#9ACB0D"));
indeterminateStyle.TrackStroke = Color.FromArgb("#9ACB0D");
indeterminateStyle.ThumbStroke = Color.FromArgb("#9ACB0D");
...
* [TrackCornerRadius](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_TrackCornerRadius): Represents a `CornerRadius` value used to create curved corners for the track.
* [TrackStrokeThickness](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_TrackStrokeThickness): Represents a double value used to define the track border width.
* [TrackWidthRequest](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_TrackWidthRequest): Represents a double value used to define the track width.
* [TrackHeightRequest](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_TrackHeightRequest): Represents a double value used to define the track height.
* [ThumbCornerRadius](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_ThumbCornerRadius): Represents a `CornerRadius` value used to create curved corners for the thumb.
* [ThumbStrokeThickness](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.SwitchSettings.html#Syncfusion_Maui_Buttons_SwitchSettings_ThumbStrokeThickness): Represents a double value used to define the thumb border width.
...
offStyle.TrackCornerRadius = 6;
offStyle.ThumbCornerRadius = 6;
...
The .NET MAUI Switch control lets you customize the thumb's icon using the following properties:
...
onStyle.IconColor = Color.FromArgb("#006400");
...
indeterminateStyle.IconColor = Color.FromArgb("#FB9604");
