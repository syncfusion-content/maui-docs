---
layout: post
title: Filtering in .NET MAUI ComboBox | Syncfusion®
description: Learn here all about filtering options in Syncfusion® .NET MAUI ComboBox (SfComboBox) control and more.
platform: maui
control: SfComboBox
documentation: ug
