---
layout: post
title: Searching in .NET MAUI ComboBox control | Syncfusion<sup>®</sup>
description: Learn how to perform the searching operation in Syncfusion<sup>®</sup> .NET MAUI ComboBox (SfComboBox) control and more.
platform: maui
control: SfComboBox
documentation: ug
