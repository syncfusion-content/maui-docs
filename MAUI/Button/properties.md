...
<table>
	...
	<tr valign="top">
		...
		<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View float type in API reference">float</a></td>
...
<table>
	...
	<tr valign="top">
		...
		<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler?view=net-10.0" aria-label="View EventHandler type in API reference">EventHandler</a>&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventargs?view=net-10.0" aria-label="View EventArgs type in API reference">EventArgs&gt;</a></td>
