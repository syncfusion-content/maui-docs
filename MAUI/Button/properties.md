---
layout: post
title: Properties in .NET MAUI Button | Syncfusion®
description: This section explains the properties and events with Syncfusion® .NET MAUI Button (SfButton) control.
platform: maui
control: SfButton
documentation: ug
---

# API Reference in .NET MAUI Button
