---
layout: post
title: Visual States in .NET MAUI Button | Syncfusion®
description: Learn about visual states support in the Syncfusion® .NET MAUI Button control and how to customize each state.
platform: maui
control: SfButton
documentation: ug
---
...
`SfButton` supports the following visual states through the [`VisualStateManager`](https://learn.microsoft.com/dotnet/maui/user-interface/visual-states?view=net-maui-10.0):
