...
description: Learn all about the Syncfusion® .NET MAUI Linear ProgressBar (SfLinearProgressBar) control, its features, and elements.
platform: MAUI
...
- **Multiple progress states support** allows visualizing determinate, indeterminate, and buffer progress scenarios.  
...
<a href="https://www.syncfusion.com/maui-controls/maui-progressbar" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/linear-progressbar" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
