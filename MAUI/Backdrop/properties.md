...
<tr valign="top">
	...
	<td>View placed behind the front layer. Secondary content appears in this layer.</td>
</tr>
...
<tr valign="top">
	...
	<td>Mode that defines how the back layer is revealed. Choose <code>Fill</code> to fill the page or <code>Auto</code> to fit the content.</td>
</tr>
...
<tr valign="top">
	...
	<td>Image shown for the close icon in the navigation bar. A custom icon replaces the default.</td>
</tr>
...
<tr valign="top">
	...
	<td>Accessibility text used by the close icon. It is announced by screen readers.</td>
</tr>
...
<tr valign="top">
	...
	<td>Root view that contains the content of the page. The page is rendered from this view.</td>
</tr>
...
<tr valign="top">
	...
	<td>Template used to display the page content. A custom template changes the page layout.</td>
</tr>
...
<tr valign="top">
	...
	<td>View placed in front of the back layer. Primary content appears in this layer.</td>
</tr>
...
<tr valign="top">
	...
	<td>Determines whether the back layer is in the expanded state. The back layer is visible when enabled.</td>
</tr>
...
<tr valign="top">
	...
	<td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.imagesource" aria-label="View ImageSource type in API reference">ImageSource</a></td>
	<td>Image shown for the open icon in the navigation bar. A custom icon replaces the default.</td>
</tr>
...
<tr valign="top">
	...
	<td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
	<td>Accessibility text used by the open icon. It is announced by screen readers.</td>
</tr>
...
<tr valign="top">
	...
	<td>Fires when the back layer is revealed or concealed. The current state of the back layer is provided.</td>
</tr>
