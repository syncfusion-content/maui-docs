...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.controltemplate" aria-label="View ControlTemplate type in API reference">ControlTemplate</a></td>
