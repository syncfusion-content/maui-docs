---
layout: post
title: Customization in .NET MAUI Effects View control | Syncfusion<sup>®</sup>
description: Learn here all about Customization support in Syncfusion<sup>®</sup> .NET MAUI Effects View (SfEffectsView) control and more.
platform: maui
