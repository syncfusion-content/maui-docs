...
Description: Learn here all about appointment drag and drop support in the Syncfusion Essential .NET MAUI Scheduler(SfScheduler) control, it's elements and more details.
platform: maui
control: SfScheduler
documentation: ug
---
