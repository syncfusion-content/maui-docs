---
layout: post
title: Free Text Annotation in .NET MAUI PDF Viewer Control | Syncfusion<sup>&reg;</sup>
description: Learn here about Free Text Annotation in Syncfusion<sup>&reg;</sup> .NET MAUI PDF Viewer (SfPdfViewer) control and its functions.
platform: MAUI
control: SfPdfViewer
documentation: ug
