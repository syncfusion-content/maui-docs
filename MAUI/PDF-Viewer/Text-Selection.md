...
In mobile platforms such as Android and iOS, the long-press text selection feature allows you to select text by pressing and holding your finger on the screen. Refer to the following steps for long-press text selection on a mobile device.
...
N> The color of the selection handles will also be modified to match the text highlight color, but with full opacity.
