---
layout: post
title: Add, Remove, and Edit Annotations in .NET MAUI PDF Viewer | Syncfusion<sup>&reg;</sup>
description: Learn here all about adding, removing and editing annotations in a PDF document using Syncfusion<sup>&reg;</sup> .NET MAUI PDF Viewer (SfPdfViewer) control.
platform: MAUI
control: SfPdfViewer
documentation: ug
