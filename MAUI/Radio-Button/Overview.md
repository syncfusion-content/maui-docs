...
The Syncfusion<sup>®</sup> [.NET MAUI Radio Button](https://www.syncfusion.com/maui-controls/maui-radio-button) is a selection control that allows users to select one option from a set. The two states of the Radio Button are checked and unchecked.
...
<a href="https://www.syncfusion.com/maui-controls/maui-radio-button" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/radio-button" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/1286" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
      Explore a real-world application that demonstrates the practical use of the RadioButton.
    </div>
