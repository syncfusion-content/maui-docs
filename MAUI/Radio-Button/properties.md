...
<tr valign="top">
    ...
    <td>Defines the color used to render the checked state and provides the primary visual accent for the selected radio button.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Defines the spacing between the selection indicator and the text content, helping control the overall balance of the control layout.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
    <td>Defines the size of the radio button indicator and controls the visual scale of the circular selection mark.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Determines whether selection state changes are animated and controls the motion feedback when the checked state updates.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
    <td>Determines whether the text automatically scales with the system font settings and supports accessibility-friendly typography.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Defines the group identifier used to associate radio buttons so that only one item in the same group can remain selected at a time.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
    <td>Determines whether the radio button is selected and reflects the current checked state of the control.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
    <td>Defines the text displayed alongside the radio button indicator and provides the visible label for the control.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
    <td>Defines the color of the text displayed next to the radio button and controls the label appearance in different visual states.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
    <td>Defines the color used to render the unchecked state and provides the visual appearance for the unselected indicator.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Defines the value associated with the radio button and allows the control to participate in group-based selection scenarios.</td>
</tr>
</table>
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.StateChangedEventArgs.html" aria-label="View StateChangedEventArgs type in API reference">StateChangedEventArgs</a></td>
    <td>Raised when the checked state changes and the updated selection state becomes available for handling.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Buttons.StateChangingEventArgs.html" aria-label="View StateChangingEventArgs type in API reference">StateChangingEventArgs</a></td>
    <td>Raised before the checked state changes and provides a chance to inspect or adjust the pending transition.</td>
</tr>
</table>
