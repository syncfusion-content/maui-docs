---
layout: post
title: Properties of .NET MAUI Toolbar control | Syncfusion®
description: This section explains the properties, events and methods with Syncfusion® MAUI Toolbar (SfToolbar) control.
platform: maui
control: SfToolbar
documentation: ug
---
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.windows.input.icommand?view=net-10.0" aria-label="View ICommand type in API reference">ICommand</a></td>
