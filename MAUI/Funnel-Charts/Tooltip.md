...
To define the tooltip in the chart, set the [EnableTooltip]() property of [SfFunnelChart]() to true. The default value of [EnableTooltip]() property is false.
...
Funnel chart provides support to customize the appearance of the tooltip by using the [TooltipTemplate]() property.
