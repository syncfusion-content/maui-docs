...
<td>{{'[HorizontalScrollBarVisibility](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.TreeView.SfTreeView.html#Syncfusion_Maui_TreeView_SfTreeView_HorizontalScrollBarVisibility)'| markdownify }}</td>
<td>Gets or sets a value indicating whether the scrollbar should be displayed. Note: The property type changed from a Boolean `IsScrollBarVisible` in Xamarin to the [HorizontalScrollBarVisibility](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.TreeView.SfTreeView.html#Syncfusion_Maui_TreeView_SfTreeView_HorizontalScrollBarVisibility) enum in MAUI — set it to `Default`, `Always`, `Never`, or `Disabled`.</td></tr>
<td>{{'[IsScrollBarVisible](https://help.syncfusion.com/cr/xamarin/Syncfusion.XForms.TreeView.SfTreeView.html#Syncfusion_XForms_TreeView_SfTreeView_IsScrollBarVisible)'| markdownify }}</td>
<td>{{'[VerticalScrollBarVisibility](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.TreeView.SfTreeView.html#Syncfusion_Maui_TreeView_SfTreeView_VerticalScrollBarVisibility)'| markdownify }}</td>
<td>Gets or sets a value indicating whether the scrollbar should be displayed. Note: The property type changed from a Boolean `IsScrollBarVisible` in Xamarin to the [VerticalScrollBarVisibility](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.TreeView.SfTreeView.html#Syncfusion_Maui_TreeView_SfTreeView_VerticalScrollBarVisibility) enum in MAUI — set it to `Default`, `Always`, `Never`, or `Disabled`.</td></tr>
<tr>
