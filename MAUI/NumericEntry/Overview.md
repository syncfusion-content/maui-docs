---
layout: post
title: About Syncfusion® .NET MAUI Numeric Entry Control | Syncfusion®
description: Learn here all about introduction of Syncfusion® Essential Studio .NET MAUI Numeric Entry (SfNumericEntry) control, its features, and more.
platform: MAUI
...
<tr>
<td><a href="/maui/numericentry/overview" aria-label="MAUI Numeric Entry control overview">Numeric Entry</a></td>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
Explore a real-world application that demonstrates the practical use of the Numeric Entry.
    </div>
