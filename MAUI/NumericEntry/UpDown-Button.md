---
layout: post
title: UpDown Button in .NET MAUI Numeric Entry | Syncfusion®
description: Learn how to use the UpDown buttons in the Syncfusion® .NET MAUI Numeric Entry (SfNumericEntry) control.
platform: maui
