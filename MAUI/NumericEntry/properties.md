...
<table>
    ...
    <tr valign="top">
        ...
        <td>Determines whether the numeric field can represent an empty value instead of forcing a number.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>Color</code> used for the clear button icon.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>Path</code> geometry used to render the clear button icon.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>CultureInfo</code> used for parsing, formatting, and displaying numeric values.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the current cursor location inside the numeric text.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>Defines the <code>Font</code> applied to the numeric text.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>FontAttributes</code> applied to the text, such as <code>Bold</code> or <code>Italic</code>.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether font sizing follows system accessibility scaling.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
        <td>Defines the font family used to render the text.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the size of the text displayed in the control.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether the numeric value can be edited.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
        <td>Defines the highest numeric value allowed in the control.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.int32" aria-label="View Int32 type in API reference">int</a></td>
        <td>Defines the maximum number of digits allowed after the decimal separator.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
        <td>Defines the lowest numeric value allowed in the control.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Controls how percentage values are displayed using the <code>PercentDisplayMode</code> enum.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
        <td>Defines the placeholder text shown when the field is empty.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
        <td>Defines the <code>Color</code> used for the placeholder text.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>Defines the keyboard return-key action using the <code>ReturnType</code> enum.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.int32" aria-label="View Int32 type in API reference">int</a></td>
        <td>Defines the length of the currently selected text range.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether the control border is visible.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
        <td>Determines whether the clear button is displayed inside the field.</td>
    </tr>
    <tr valign="top">
        ...
        <td>Defines the <code>Brush</code> used for the control border.</td>
    </tr>
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.graphics.color" aria-label="View Color type in API reference">Color</a></td>
        <td>Defines the <code>Color</code> used for the numeric text.</td>
    </tr>
    <tr valign="top">
    ...
    <tr valign="top">
        ...
        <td>Defines when the numeric value is updated while editing using the <code>ValueChangeMode</code> enum.</td>
    </tr>
</table>
...
<table>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.focuseventargs" aria-label="View FocusEventArgs type in API reference">FocusEventArgs</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.NumericEntryValueChangedEventArgs.html" aria-label="View NumericEntryValueChangedEventArgs type in API reference">NumericEntryValueChangedEventArgs</a></td>
