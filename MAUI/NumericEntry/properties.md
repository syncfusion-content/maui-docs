...
<table>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.globalization.cultureinfo" aria-label="View CultureInfo type in API reference">CultureInfo</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.font" aria-label="View Font type in API reference">Font</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.NumericEntryUpDownPlacementMode.html" aria-label="View UpDownPlacementMode enum in API reference">UpDownPlacementMode</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.nullable-1" aria-label="View Nullable type in API reference">double?</a></td>
...
<table>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler type in API reference">EventHandler</a></td>
    ...
    <tr valign="top">
        ...
        <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler type in API reference">EventHandler&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.focuseventargs" aria-label="View FocusEventArgs type in API reference">FocusEventArgs&gt;</a></a></td>
