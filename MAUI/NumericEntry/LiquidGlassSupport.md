...
3. Set the `Background` property of the `Numeric Entry` to `Transparent` so the glass-like effect is preserved across the control.

For more information about the Liquid Glass Effect, refer to the [Liquid Glass Getting Started documentation](https://helpstaging.syncfusion.com/maui/liquid-glass-ui/getting-started).
