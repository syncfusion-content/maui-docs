...
![Axis Background in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-background.png)
...
![Axis Scale Range in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-range.png)
...
![Axis Label Interval in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-interval.png)
...
![Axis Angle in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-with-axis-angle.png)
...
![Axis Radius in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-with-axis-radius.png)
    ...
    <gauge:SfRadialGauge.Axes>
        <gauge:RadialAxis CanScaleToFit = "False" StartAngle = "180"
            ...
            <gauge:RadialAxis.AxisLineStyle>
                <gauge:RadialLineStyle Fill = "#FF355C7D"/>
            </gauge:RadialAxis.AxisLineStyle>
        </gauge:RadialAxis>
    </gauge:SfRadialGauge.Axes>
</gauge:SfRadialGauge>
...
![Axis Fit to Scale in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-with-axis-fit-to-scale.png)
...
![Axis Label Rotation in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-rotation.png)
...
![Axis Edge Label in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-edge-label.png)
...
![Axis Direction in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-direction.png)
...
![Axis Maximum Labels in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-maximum-labels.png)

## Axis line customization

The radial axis line can be customized using the [`AxisLineStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html#Syncfusion_Maui_Gauges_RadialAxis_AxisLineStyle) of the [`RadialAxis`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html). The following properties are available in the [`RadialLineStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html) class:

* [`Thickness`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html#Syncfusion_Maui_Gauges_RadialLineStyle_Thickness), of type `double`, customizes the thickness of the axis line.
* [`ThicknessUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html#Syncfusion_Maui_Gauges_RadialLineStyle_ThicknessUnit), of the [`SizeUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.SizeUnit.html) enum, specifies whether the thickness value is interpreted in pixels or as a factor of the axis radius. Its default value is `SizeUnit.Pixel`.
* [`Fill`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html#Syncfusion_Maui_Gauges_RadialLineStyle_Fill), of type `Brush`, customizes the color of the axis line.
* [`GradientStops`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html#Syncfusion_Maui_Gauges_RadialLineStyle_GradientStops), of type `ObservableCollection<GaugeGradientStop>`, allows you to apply a gradient brush to the axis line.
...
![Axis Line Width in Pixel in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-line-width-in-pixel.png)
...
![Axis Line Width in Factor in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-line-width-in-factor.png)

### Setting axis line fill brush

To apply a brush to the axis line, use the [`Fill`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html#Syncfusion_Maui_Gauges_RadialLineStyle_Fill) property of [`RadialLineStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialLineStyle.html).
...
![Axis Line Fill color in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-line-stroke-color.png)
...
![Axis Gradient Line in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-gradient-line.png)
...
![Axis Line Visibility in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-line-visibility.png)

## Axis label customization

The axis labels can be customized using the [`AxisLabelStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html#Syncfusion_Maui_Gauges_RadialAxis_AxisLabelStyle) of the [`RadialAxis`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html). The following properties are available in the [`GaugeLabelStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html) class:

* [`TextColor`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html#Syncfusion_Maui_Gauges_GaugeLabelStyle_TextColor), of type `Color`, customizes the color of the labels.
* [`FontAttributes`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html#Syncfusion_Maui_Gauges_GaugeLabelStyle_FontAttributes), of the `FontAttributes` enum, specifies the font attribute (such as bold or italic) for the labels.
* [`FontSize`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html#Syncfusion_Maui_Gauges_GaugeLabelStyle_FontSize), of type `double`, specifies the font size for the labels.
* [`FontFamily`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html#Syncfusion_Maui_Gauges_GaugeLabelStyle_FontFamily), of type `string`, specifies the font family for the labels.
...
![Axis Label Customization in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-customization.png)
...
![Axis Label Format in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-format.png)
...
![Axis Label Visibility in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-visibility.png)
...
![Axis Label Placement in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-placement.png)
...
![Axis Label Offset in Pixel in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-offset-pixel.png)
...
![Axis Label Offset factor in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-label-offset-factor.png)
...
The major and minor tick lines of an axis can be customized using the [`MajorTickStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html#Syncfusion_Maui_Gauges_RadialAxis_MajorTickStyle) and [`MinorTickStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html#Syncfusion_Maui_Gauges_RadialAxis_MinorTickStyle) of the [`RadialAxis`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html). The following properties are available in the [`RadialTickStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialTickStyle.html) class:

* [`Length`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeTickStyle.html#Syncfusion_Maui_Gauges_GaugeTickStyle_Length), of type `double`, specifies the length of the ticks.

* [`LengthUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialTickStyle.html#Syncfusion_Maui_Gauges_RadialTickStyle_LengthUnit), of the [`SizeUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.SizeUnit.html) enum, specifies whether the tick length is interpreted in pixels or as a factor of the axis radius.

* [`Stroke`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeTickStyle.html#Syncfusion_Maui_Gauges_GaugeTickStyle_Stroke), of type `Brush`, specifies the color for the tick line.

* [`StrokeThickness`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeTickStyle.html#Syncfusion_Maui_Gauges_GaugeTickStyle_StrokeThickness), of type `double`, specifies the width of the tick line.

* [`StrokeDashArray`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeTickStyle.html#Syncfusion_Maui_Gauges_GaugeTickStyle_StrokeDashArray), of type `DoubleCollection`, specifies the dash array for the tick line.
...
![Axis Tick Length in Pixel in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-tick-length-in-pixel.png)
...
![Axis Tick Length in Factor in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-tick-length-in-factor.png)
...
![Customized Tick Lines in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-customized-tick-lines.png)
...
![Tick Line Visibility in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-tick-line-visibility.png)
...
![Tick Placement in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-tick-placement.png)
...
![Axis Tick Offset in Pixel in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-tick-offset-pixel.png)
...
![Axis Tick Offset Factor in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-tick-offset-factor.png)
...
![Multiple Axis in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-multiple-axis.png)
...
![Custom Scale in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-custom-scale.png)

## Events

### LabelCreated

The [`LabelCreated`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialAxis.html#Syncfusion_Maui_Gauges_RadialAxis_LabelCreated) event is triggered each time a label is created for use. The following properties are available in the [`LabelCreatedEventArgs`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.LabelCreatedEventArgs.html):

* [`Text`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.LabelCreatedEventArgs.html#Syncfusion_Maui_Gauges_LabelCreatedEventArgs_Text), of type `string`, customizes the text of the label.
* [`Style`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.LabelCreatedEventArgs.html#Syncfusion_Maui_Gauges_LabelCreatedEventArgs_Style), of type [`GaugeLabelStyle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeLabelStyle.html), customizes the text style of the label.
...
![Axis Events in .NET MAUI Radial Gauge](images/axis/maui-radial-gauge-axis-events.png)
