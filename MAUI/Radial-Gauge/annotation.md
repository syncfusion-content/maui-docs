...
* [`DirectionValue`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_DirectionValue), of type `double`, specifies the value that indicates the direction of the annotation based on the [`DirectionUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_DirectionUnit) property. 

* [`DirectionUnit`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_DirectionUnit), of the [`AnnotationDirection`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.AnnotationDirection.html) enum, specifies whether the direction is calculated based on the axis value or the angle. The available values are [`AxisValue`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.AnnotationDirection.html#Syncfusion_Maui_Gauges_AnnotationDirection_AxisValue) and [`Angle`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.AnnotationDirection.html#Syncfusion_Maui_Gauges_AnnotationDirection_Angle). The default value is `Angle`.

* [`PositionFactor`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_PositionFactor), of type `double`, specifies the factor value (from 0 to 1) to adjust the annotation distance from the center point. The default value is `0`.

* [`HorizontalAlignment`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_HorizontalAlignment), of the [`GaugeAlignment`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAlignment.html) enum, specifies the horizontal alignment for positioning the annotation.
...
![Annotation Position in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-annotation-position.png)
...
![Annotation Position with Angle in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-annotation-position-with-angle.png)
...
![Annotation Position with Axis in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-annotation-position-with-axis.png)

The [`PositionFactor`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_PositionFactor) moves the annotation from the center of the axis toward its edge. For example, when [`PositionFactor`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_PositionFactor) is set to `0.5`, the annotation is moved from the center to the corresponding direction by half the radius value of the axis. The default value of [`PositionFactor`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_PositionFactor) is `0`, which positions the annotation at the center of the axis.
...
![Image Annotation in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-image-annotation.png)

## Alignment of annotation

[`Annotation`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html) can be aligned to `Start`, `Center`, or `End` using the [`HorizontalAlignment`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_HorizontalAlignment) and [`VerticalAlignment`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAnnotation.html#Syncfusion_Maui_Gauges_GaugeAnnotation_VerticalAlignment) properties of the annotation. Both properties use the [`GaugeAlignment`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.GaugeAlignment.html) enum, and their default value is `Center`.
...
![Annotation Horizontal Alignment in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-annotation-horizontal-alignment.png)
...
![Annotation Vertical Alignment in .NET MAUI Radial Gauge](images/annotation/maui-radial-gauge-annotation-vertical-alignment.png)
