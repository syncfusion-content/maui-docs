---
layout: post
title: Animation in .NET MAUI Radial Gauge | Syncfusion®
description: Animation in .NET MAUI Radial Gauge provides smooth transitions for gauge elements, improving visual feedback and enhancing the overall user experience.
platform: maui
...
![Loading Animation in .NET MAUI Radial Gauge](images/animation/maui-radial-gauge-loading-animation.gif)


## Pointer animation

The [`EnableAnimation`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialPointer.html#Syncfusion_Maui_Gauges_RadialPointer_EnableAnimation) property of pointer allows you to enable or disable the pointer animation. The default value of [`EnableAnimation`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialPointer.html#Syncfusion_Maui_Gauges_RadialPointer_EnableAnimation) is `true`.
...
![Animation in .NET MAUI Radial Gauge](images/animation/maui-radial-gauge-animation.gif)

## Animation duration

The pointer's [`AnimationDuration`](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Gauges.RadialPointer.html#Syncfusion_Maui_Gauges_RadialPointer_AnimationDuration) property allows you to control the animation duration in milliseconds. The default value of the animation duration is `1000` ms.
...
![Animation Duration in .NET MAUI Radial Gauge](images/animation/maui-radial-gauge-animation-duration.gif)
