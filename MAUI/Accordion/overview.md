...
The **[.NET MAUI Accordion](https://www.syncfusion.com/maui-controls/maui-accordion)** (SfAccordion) offers a vertically collapsible panel with stacked headers, allowing the expansion or collapse of one or multiple items simultaneously.

![Syncfusion .NET MAUI accordion overview ](Images/overview_images/accordion_overview.png)
...
<a href="https://www.syncfusion.com/maui-controls/maui-accordion" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Accordion" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/accordion" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
