---
layout: post
title: Liquid Glass Effect in .NET MAUI Smart Text Editor | Syncfusion®
...
![Liquid glass effect in .NET MAUI Smart Text Editor](images/liquid-glass-effect/liquid-glass-effect-in-maui-smart-text-editor.png)
