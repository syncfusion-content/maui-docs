---
layout: post
title: Claude AI Integration with .NET MAUI Smart Text Editor | Syncfusion
description: Learn how to implement a custom AI service using the Claude API with Syncfusion<sup>&reg;</sup> Smart Text Editor (SfSmartTextEditor) control.
platform: maui
