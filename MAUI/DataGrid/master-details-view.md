---
layout: post
title: Master Details View in .NET MAUI DataGrid | Syncfusion®
description: Learn how to use Master Details View in Syncfusion® .NET MAUI DataGrid to display hierarchical data with expandable parent and child records.
platform: MAUI
control: SfDataGrid
documentation: UG
...
# Master Details View in .NET MAUI DataGrid
