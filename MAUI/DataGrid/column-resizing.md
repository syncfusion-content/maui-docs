---
layout: post
title: Column Resizing in .NET MAUI DataGrid | Syncfusion®
description: Learn all about column resizing support in Syncfusion® .NET MAUI DataGrid, including resizing modes, customization options, and usage examples.
platform: MAUI
control: SfDataGrid
documentation: ug
...
# Columns Resizing in .NET MAUI DataGrid
