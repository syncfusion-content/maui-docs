...
<table>
	...
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_View" aria-label="View collection view property in API reference">View</a></td>
...
<table>
	...
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_AutoGeneratingColumn" aria-label="AutoGeneratingColumn event documentation">AutoGeneratingColumn</a></td>
		<td>DataGridAutoGeneratingColumnEventArgs</td>
		<td>Raised when a column is automatically generated from the data source.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_AutoGeneratingRelations" aria-label="AutoGeneratingRelations event documentation">AutoGeneratingRelations</a></td>
		<td>DataGridAutoGeneratingRelationsArgs</td>
		<td>Raised when relations are automatically generated for the DataGrid.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellDoubleTapped" aria-label="CellDoubleTapped event documentation">CellDoubleTapped</a></td>
		<td>DataGridCellDoubleTappedEventArgs</td>
		<td>Raised when a cell is double-tapped.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellEntered" aria-label="CellEntered event documentation">CellEntered</a></td>
		<td>DataGridCellEnteredEventArgs</td>
		<td>Raised when the pointer enters a cell.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellExited" aria-label="CellExited event documentation">CellExited</a></td>
		<td>DataGridCellExitedEventArgs</td>
		<td>Raised when the pointer exits a cell.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellHovered" aria-label="CellHovered event documentation">CellHovered</a></td>
		<td>DataGridCellHoveredEventArgs</td>
		<td>Raised when the pointer hovers over a cell.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellLongPress" aria-label="CellLongPress event documentation">CellLongPress</a></td>
		<td>DataGridCellLongPressEventArgs</td>
		<td>Raised when a cell is long-pressed.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellRightTapped" aria-label="CellRightTapped event documentation">CellRightTapped</a></td>
		<td>DataGridCellRightTappedEventArgs</td>
		<td>Raised when a cell is right-clicked or right-tapped.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellTapped" aria-label="CellTapped event documentation">CellTapped</a></td>
		<td>DataGridCellTappedEventArgs</td>
		<td>Raised when a cell is tapped.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CellValueChanged" aria-label="CellValueChanged event documentation">CellValueChanged</a></td>
		<td>DataGridCellValueChangedEventArgs</td>
		<td>Raised when a cell value changes.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ColumnResizing" aria-label="ColumnResizing event documentation">ColumnResizing</a></td>
		<td>DataGridColumnResizingEventArgs</td>
		<td>Raised when a column is resized.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CurrentCellActivated" aria-label="CurrentCellActivated event documentation">CurrentCellActivated</a></td>
		<td>DataGridCurrentCellActivatedEventArgs</td>
		<td>Raised after the current cell is activated.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CurrentCellActivating" aria-label="CurrentCellActivating event documentation">CurrentCellActivating</a></td>
		<td>DataGridCurrentCellActivatingEventArgs</td>
		<td>Raised before the current cell is activated.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CurrentCellBeginEdit" aria-label="CurrentCellBeginEdit event documentation">CurrentCellBeginEdit</a></td>
		<td>DataGridCurrentCellBeginEditEventArgs</td>
		<td>Raised before current cell edit begins.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CurrentCellDropDownSelectionChanged" aria-label="CurrentCellDropDownSelectionChanged event documentation">CurrentCellDropDownSelectionChanged</a></td>
		<td>CurrentCellDropDownSelectionChangedEventArgs</td>
		<td>Raised when a drop-down selection changes in the current cell.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CurrentCellEndEdit" aria-label="CurrentCellEndEdit event documentation">CurrentCellEndEdit</a></td>
		<td>DataGridCurrentCellEndEditEventArgs</td>
		<td>Raised after current cell edit ends.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DataGridLoaded" aria-label="DataGridLoaded event documentation">DataGridLoaded</a></td>
		<td>EventArgs</td>
		<td>Raised when the grid is loaded.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewCollapsed" aria-label="DetailsViewCollapsed event documentation">DetailsViewCollapsed</a></td>
		<td>DataGridDetailsViewCollapsedEventArgs</td>
		<td>Raised after a details view collapses.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewCollapsing" aria-label="DetailsViewCollapsing event documentation">DetailsViewCollapsing</a></td>
		<td>DataGridDetailsViewCollapsingEventArgs</td>
		<td>Raised before a details view collapses.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewExpanded" aria-label="DetailsViewExpanded event documentation">DetailsViewExpanded</a></td>
		<td>DataGridDetailsViewExpandedEventArgs</td>
		<td>Raised after a details view expands.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewExpanding" aria-label="DetailsViewExpanding event documentation">DetailsViewExpanding</a></td>
		<td>DataGridDetailsViewExpandingEventArgs</td>
		<td>Raised before a details view expands.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewLoading" aria-label="DetailsViewLoading event documentation">DetailsViewLoading</a></td>
		<td>DataGridDetailsViewLoadingEventArgs</td>
		<td>Raised when a details view starts loading.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_DetailsViewUnloading" aria-label="DetailsViewUnloading event documentation">DetailsViewUnloading</a></td>
		<td>DataGridDetailsViewUnloadingEventArgs</td>
		<td>Raised when a details view is unloaded.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_GroupCollapsed" aria-label="GroupCollapsed event documentation">GroupCollapsed</a></td>
		<td>DataGridColumnGroupChangedEventArgs</td>
		<td>Raised after a group collapses.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_GroupCollapsing" aria-label="GroupCollapsing event documentation">GroupCollapsing</a></td>
		<td>DataGridColumnGroupChangingEventArgs</td>
		<td>Raised before a group collapses.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_GroupExpanded" aria-label="GroupExpanded event documentation">GroupExpanded</a></td>
		<td>DataGridColumnGroupChangedEventArgs</td>
		<td>Raised after a group expands.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_GroupExpanding" aria-label="GroupExpanding event documentation">GroupExpanding</a></td>
		<td>DataGridColumnGroupChangingEventArgs</td>
		<td>Raised before a group expands.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ItemsSourceChanged" aria-label="ItemsSourceChanged event documentation">ItemsSourceChanged</a></td>
		<td>DataGridItemsSourceChangedEventArgs</td>
		<td>Raised when the items source changes.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_QueryColumnDragging" aria-label="QueryColumnDragging event documentation">QueryColumnDragging</a></td>
		<td>DataGridQueryColumnDraggingEventArgs</td>
		<td>Raised when column dragging is queried.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_QueryRowDragging" aria-label="QueryRowDragging event documentation">QueryRowDragging</a></td>
		<td>DataGridQueryRowDraggingEventArgs</td>
		<td>Raised when row dragging is queried.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_QueryRowHeight" aria-label="QueryRowHeight event documentation">QueryRowHeight</a></td>
		<td>DataGridQueryRowHeightEventArgs</td>
		<td>Raised when a row height is queried.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_QueryUnboundColumnValue" aria-label="QueryUnboundColumnValue event documentation">QueryUnboundColumnValue</a></td>
		<td>DataGridUnboundColumnEventArgs</td>
		<td>Raised when an unbound column value is queried.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_QueryUnboundRow" aria-label="QueryUnboundRow event documentation">QueryUnboundRow</a></td>
		<td>DataGridUnboundRowEventArgs</td>
		<td>Raised when an unbound row is queried.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SelectionChanged" aria-label="SelectionChanged event documentation">SelectionChanged</a></td>
		<td>DataGridSelectionChangedEventArgs</td>
		<td>Raised when selection changes.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SelectionChanging" aria-label="SelectionChanging event documentation">SelectionChanging</a></td>
		<td>DataGridSelectionChangingEventArgs</td>
		<td>Raised before selection changes.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SortColumnsChanged" aria-label="SortColumnsChanged event documentation">SortColumnsChanged</a></td>
		<td>DataGridSortColumnsChangedEventArgs</td>
		<td>Raised when sorted columns change.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SortColumnsChanging" aria-label="SortColumnsChanging event documentation">SortColumnsChanging</a></td>
		<td>DataGridSortColumnsChangingEventArgs</td>
		<td>Raised before sorted columns change.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SwipeEnded" aria-label="SwipeEnded event documentation">SwipeEnded</a></td>
		<td>DataGridSwipeEndedEventArgs</td>
		<td>Raised when swipe interaction ends.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_SwipeStarting" aria-label="SwipeStarting event documentation">SwipeStarting</a></td>
		<td>DataGridSwipeStartingEventArgs</td>
		<td>Raised before swipe interaction starts.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_Swiping" aria-label="Swiping event documentation">Swiping</a></td>
		<td>DataGridSwipingEventArgs</td>
		<td>Raised while swiping.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ViewCreated" aria-label="ViewCreated event documentation">ViewCreated</a></td>
		<td>EventArgs</td>
...
<table>
	...
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_CollapseAllDetailsView" aria-label="CollapseAllDetailsView method documentation">CollapseAllDetailsView()</a></td>
		<td>void</td>
		<td>Collapses all details views.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ExpandAllDetailsView" aria-label="ExpandAllDetailsView method documentation">ExpandAllDetailsView()</a></td>
		<td>void</td>
		<td>Expands all details views.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_GetSelectedCells" aria-label="GetSelectedCells method documentation">GetSelectedCells()</a></td>
		<td>void</td>
		<td>Returns the selected cells.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_EndEdit" aria-label="EndEdit method documentation">EndEdit()</a></td>
		<td>void</td>
		<td>Ends the current editing session.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ClearSelection" aria-label="ClearSelection method documentation">ClearSelection()</a></td>
		<td>void</td>
		<td>Clears the current selection.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ScrollToColumnIndex_System_Int32_" aria-label="ScrollToColumnIndex method documentation">ScrollToColumnIndex(int)</a></td>
		<td>void</td>
		<td>Scrolls to the specified column index.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.DataGrid.SfDataGrid.html#Syncfusion_Maui_DataGrid_SfDataGrid_ScrollToRowIndex_System_Int32_" aria-label="ScrollToRowIndex method documentation">ScrollToRowIndex(int)</a></td>
		<td>void</td>
