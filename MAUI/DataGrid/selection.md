...
## Keyboard Modifier Key Tracking
The `SfDataGrid` now supports tracking of keyboard modifier keys `Shift`, `Control`, and `Command` to enable enhanced selection behavior across platforms.

### Enable Modifier Key Tracking
Modifier key tracking is internally handled by the `DataGridSelectionController` class. It allows to implement familiar multi-selection and extended selection patterns using keyboard shortcuts.

### Properties Introduced
The following properties are added to the `DataGridSelectionController`:
...
<tr>
<td>
{{'[IsControlKeyPressed]()'| markdownify }}
</td>
<td>
...
<tr>
<td>
{{'[IsCommandKeyPressed]()'| markdownify }}
</td>
<td>
Indicates whether the Command key is currently pressed (specific to macOS and iOS).
</td>
</tr>
</table>
...
else if (selectionController.IsControlKeyPressed || selectionController.IsCommandKeyPressed)
{
