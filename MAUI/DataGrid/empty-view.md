---
layout: post
title: Empty View in .NET MAUI DataGrid | Syncfusion®
description: Learn how to display and customize an empty view in Syncfusion® .NET MAUI DataGrid when no data is available.
platform: MAUI
control: SfDataGrid
documentation: UG
---

# Empty View in .NET MAUI DataGrid
