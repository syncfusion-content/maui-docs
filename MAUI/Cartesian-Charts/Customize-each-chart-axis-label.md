---
layout: post
title: How to Use Callback Event for Axis Labels in MAUI Chart | Syncfusion®
description: Customize each chart axis label using the callback event in Syncfusion® .NET MAUI Cartesian Chart control to display formatted labels and improve readability.
platform: maui
