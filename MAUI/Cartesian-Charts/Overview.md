...
# .NET MAUI Cartesian Chart Overview (SfCartesianChart)
...
- Area charts  
- Scatter charts  
- Range and combination series  

Explore chart types: [Chart Types Documentation](https://help.syncfusion.com/maui/cartesian-charts/column)
...
- Labels and legends  
- Series appearance and markers  
- Colors and themes  

Learn more: [Customization Guide](https://help.syncfusion.com/maui/cartesian-charts/appearance)

## Supported Platforms

The SfCartesianChart is built for cross-platform applications and supports:
...
Built for performance-critical scenarios:
...
- [Chart Types and Series](https://help.syncfusion.com/maui/cartesian-charts/column)
- [Customization and Styling](https://help.syncfusion.com/maui/cartesian-charts/appearance)
- [API Reference for SfCartesianChart](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SfCartesianChart.html)
