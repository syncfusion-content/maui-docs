...
![Line chart type in .NET MAUI Cartesian Chart](Chart-types-images/maui_line_chart.png)

### Dashed line

The [StrokeDashArray](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LineSeries.html#Syncfusion_Maui_Charts_LineSeries_StrokeDashArray) property of [LineSeries](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LineSeries.html), of type `DoubleCollection`, is used to render the line series with dashes. Values at odd indices define the dash length, while values at even indices define the gap.
...
![Dashed line chart in .NET MAUI Cartesian Chart](Chart-types-images/maui_dashed_line_chart.png)

## Spline Chart

The [SplineSeries](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SplineSeries.html) resembles the line series, but instead of connecting the data points with line segments, the data points are connected by smooth bezier curves. It supports the same marker and customization options as `LineSeries`.
...
![Spline chart type in .NET MAUI Cartesian Chart](Chart-types-images/maui_spline_chart.png)

### Spline rendering types

The [Type](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SplineSeries.html#Syncfusion_Maui_Charts_SplineSeries_Type) property allows you to change the rendering type of the spline curve in the series. The default value of [Type](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SplineSeries.html#Syncfusion_Maui_Charts_SplineSeries_Type) is [Natural](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.SplineType.html#Syncfusion_Maui_Charts_SplineType_Natural).
...
![Spline types chart in .NET MAUI Cartesian Chart](Chart-types-images/maui_spline_types_chart.png)
...
![Marker support in .NET MAUI Cartesian Chart](Chart-types-images/marker_support.png)

### Marker customization

To change the series marker appearance, set the [MarkerSettings](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.LineSeries.html#Syncfusion_Maui_Charts_LineSeries_MarkerSettings) property to a new instance of [ChartMarkerSettings](https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartMarkerSettings.html). The following properties are used to customize marker appearance.
