...
# AI Powered data cleaning and preprocessing in .NET MAUI Cartesian Chart.
...
This guide shows how to use Azure OpenAI to clean and preprocess e-commerce website traffic data, then visualize the results using [Syncfusion .NET MAUI Cartesian Chart](https://help.syncfusion.com/maui/cartesian-charts/getting-started).
