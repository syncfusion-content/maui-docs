---
layout: post
title: Exporting in .NET MAUI Cartesian Chart | Syncfusion®
description: Exporting in .NET MAUI Cartesian Chart enables charts to be saved as image files for sharing, reporting, and presentation purposes.
platform: maui
