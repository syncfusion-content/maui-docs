---
layout: post
title: ChartZoomPanBehavior in .NET MAUI Cartesian Chart | Syncfusion®
description: This section lists the public API members for ChartZoomPan Behaviors in the Syncfusion® .NET MAUI Cartesian Chart (SfCartesianChart).
platform: maui
