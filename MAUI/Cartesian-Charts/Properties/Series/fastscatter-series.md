...
# FastScatterSeries API in .NET MAUI Cartesian Chart
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.FastScatterSeries.html#Syncfusion_Maui_Charts_FastScatterSeries_PointHeight" aria-label="View PointHeight property in API reference">PointHeight</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Sets the <code>height</code> of each scatter point symbol.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.FastScatterSeries.html#Syncfusion_Maui_Charts_FastScatterSeries_PointWidth" aria-label="View PointWidth property in API reference">PointWidth</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Sets the <code>width</code> of each scatter point symbol.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.FastScatterSeries.html#Syncfusion_Maui_Charts_FastScatterSeries_Stroke" aria-label="View Stroke property in API reference">Stroke</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
    <td>Paints the <code>outline</code> of each scatter point symbol.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.FastScatterSeries.html#Syncfusion_Maui_Charts_FastScatterSeries_Type" aria-label="View Type property in API reference">Type</a></td>
    ...
    <td>Determines the <code>geometric shape</code> of each scatter point symbol, such as <code>circle</code>, <code>diamond</code>, <code>rectangle</code>, <code>hexagon</code>, <code>pentagon</code>, <code>triangle</code>, <code>star</code>, or <code>cross</code>.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.FastScatterSeries.html#Syncfusion_Maui_Charts_FastScatterSeries_GetDataPointIndex_System_Single_System_Single_" aria-label="View GetDataPointIndex method in API reference">GetDataPointIndex(Single, Single)</a></td>
