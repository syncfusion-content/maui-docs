---
layout: post
title: StackingLineSeries in .NET MAUI Cartesian Chart | Syncfusion®
description: This section lists the public API members for StackingLine series in the Syncfusion® .NET MAUI Cartesian Chart (SfCartesianChart).
platform: maui
...
<tr valign="top">
    ...
    <td>Paints the <code>interior</code> of the stacked line segments of the series.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Groups stacking line series by giving matching <code>labels</code> to two or more series, allowing them to <code>stack on top</code> of another stacked group rather than stacking onto each other.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.StackingLineSeries.html#Syncfusion_Maui_Charts_StackingLineSeries_MarkerSettings" aria-label="View MarkerSettings property in API reference">MarkerSettings</a></td>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.StackingLineSeries.html#Syncfusion_Maui_Charts_StackingLineSeries_ShowMarkers" aria-label="View ShowMarkers property in API reference">ShowMarkers</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Determines whether <code>markers</code> are rendered at each data point along the stacked line.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
    <td>Paints the <code>stroke</code> applied to the stacked line of the series.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Creates a <code>dashed</code> or <code>dotted stroke pattern</code> along the stacked line by specifying the lengths of alternating <code>dashes</code> and <code>gaps</code>.</td>
</tr>
