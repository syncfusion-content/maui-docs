---
layout: post
title: BubbleSeries in .NET MAUI Cartesian Chart | Syncfusion®
description: This section lists the public API members for Bubble series in the Syncfusion® .NET MAUI Cartesian Chart (SfCartesianChart).
platform: maui
control: SfCartesianChart
documentation: ug
---

# BubbleSeries API Reference in .NET MAUI Cartesian Chart
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.BubbleSeries.html#Syncfusion_Maui_Charts_BubbleSeries_MaximumRadius" aria-label="View MaximumRadius property in API reference">MaximumRadius</a></td>
    ...
    <td>Constrains the <code>maximum size</code> of the bubbles, ensuring they do not exceed the specified radius.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.BubbleSeries.html#Syncfusion_Maui_Charts_BubbleSeries_MinimumRadius" aria-label="View MinimumRadius property in API reference">MinimumRadius</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Constrains the <code>minimum size</code> of the bubbles, ensuring they do not shrink below the specified radius.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.BubbleSeries.html#Syncfusion_Maui_Charts_BubbleSeries_ShowZeroSizeBubbles" aria-label="View ShowZeroSizeBubbles property in API reference">ShowZeroSizeBubbles</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Renders bubbles with a <code>size value of zero</code> using the <code>minimum radius</code>.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.BubbleSeries.html#Syncfusion_Maui_Charts_BubbleSeries_SizeValuePath" aria-label="View SizeValuePath property in API reference">SizeValuePath</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.string" aria-label="View string type in API reference">string</a></td>
    <td>Maps a <code>property</code> from the data source to determine the <code>radius</code> of each bubble.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.BubbleSeries.html#Syncfusion_Maui_Charts_BubbleSeries_Stroke" aria-label="View Stroke property in API reference">Stroke</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
    <td>Paints the <code>outline</code> of the bubbles.</td>
</tr>
