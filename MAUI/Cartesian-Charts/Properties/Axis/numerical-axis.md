...
description: This section lists the public API members for Numerical Axis in the Syncfusion® .NET MAUI Cartesian Chart (SfCartesianChart).
platform: maui
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_ActualMaximum" aria-label="View ActualMaximum property in API reference">ActualMaximum</a></td>
    ...
    <td>Retrieves the <code>maximum value</code> of the axis range after numerical scaling has been applied.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_ActualMinimum" aria-label="View ActualMinimum property in API reference">ActualMinimum</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Retrieves the <code>minimum value</code> of the axis range after numerical scaling has been applied.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_Interval" aria-label="View Interval property in API reference">Interval</a></td>
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the <code>numeric distance</code> between consecutive axis labels and grid lines.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.nullable-1" aria-label="View Nullable type in API reference">Nullable&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double&gt;</a></a></td>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_PlotBands" aria-label="View PlotBands property in API reference">PlotBands</a></td>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalAxis.html#Syncfusion_Maui_Charts_NumericalAxis_RangePadding" aria-label="View RangePadding property in API reference">RangePadding</a></td>
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.NumericalPadding.html" aria-label="View NumericalPadding type in API reference">NumericalPadding</a></td>
    <td>Adjusts the <code>start</code> and <code>end values</code> of the axis range to include extra space or fit the plotted data neatly.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Converts a specific <code>screen coordinate</code> into its corresponding <code>data value</code> on the numerical axis.</td>
</tr>
