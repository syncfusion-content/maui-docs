...
# DateTimeAxis API Reference for .NET MAUI Cartesian Chart
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeAxis.html#Syncfusion_Maui_Charts_DateTimeAxis_AutoScrollingDeltaType" aria-label="View AutoScrollingDeltaType property in API reference">AutoScrollingDeltaType</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeIntervalType.html" aria-label="View DateTimeIntervalType type in API reference">DateTimeIntervalType</a></td>
<td>Determines the <code>time unit</code>, such as years, months, days, or hours, used to calculate the visible range when auto-scrolling is enabled.</td>
</tr>
...
<td>Controls the <code>visibility</code> of the first and last labels on the axis during zooming or panning.</td>
</tr>
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeAxis.html#Syncfusion_Maui_Charts_DateTimeAxis_IntervalType" aria-label="View IntervalType property in API reference">IntervalType</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeIntervalType.html" aria-label="View DateTimeIntervalType type in API reference">DateTimeIntervalType</a></td>
<td>Defines the <code>time unit</code>, such as years, months, days, or hours, for the interval between axis labels.</td>
</tr>
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeAxis.html#Syncfusion_Maui_Charts_DateTimeAxis_PlotBands" aria-label="View PlotBands property in API reference">PlotBands</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimePlotBandCollection.html" aria-label="View DateTimePlotBandCollection type in API reference">DateTimePlotBandCollection</a></td>
<td>Defines a collection of <code>rectangular regions</code> highlighted across the axis to visually group or separate ranges of dates.</td>
</tr>
...
<tr valign="top">
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeAxis.html#Syncfusion_Maui_Charts_DateTimeAxis_RangePadding" aria-label="View RangePadding property in API reference">RangePadding</a></td>
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeRangePadding.html" aria-label="View DateTimeRangePadding type in API reference">DateTimeRangePadding</a></td>
<td>Adjusts the <code>start</code> and <code>end dates</code> of the axis range to include extra space or align to the nearest interval boundaries.</td>
</tr>
