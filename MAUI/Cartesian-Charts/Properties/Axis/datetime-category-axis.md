...
# DateTimeCategoryAxis API in .NET MAUI Cartesian Chart
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeCategoryAxis.html#Syncfusion_Maui_Charts_DateTimeCategoryAxis_Interval" aria-label="View Interval property in API reference">Interval</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the frequency of <code>labels</code> and <code>grid lines</code> based on the index position, used in conjunction with the IntervalType property.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeCategoryAxis.html#Syncfusion_Maui_Charts_DateTimeCategoryAxis_IntervalType" aria-label="View IntervalType property in API reference">IntervalType</a></td>
    ...
    <td>Defines the <code>time unit</code>, such as years, months, or days, for the interval between axis labels.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.DateTimeCategoryAxis.html#Syncfusion_Maui_Charts_DateTimeCategoryAxis_PlotBands" aria-label="View PlotBands property in API reference">PlotBands</a></td>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Reverses the direction of the axis, plotting data points in the <code>opposite order</code>.</td>
</tr>
