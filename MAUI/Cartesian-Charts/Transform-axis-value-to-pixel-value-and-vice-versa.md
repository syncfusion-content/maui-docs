---
layout: post
title: How to Map Axis and Pixels in .NET MAUI Cartesian Chart | Syncfusion
description: Learn how to convert an axis value to a pixel value and vice-versa in Syncfusion® .NET MAUI Cartesian Chart (SfCartesianChart) control.
platform: maui
...
# How to Convert Axis and Pixel values in .NET MAUI Cartesian Chart
