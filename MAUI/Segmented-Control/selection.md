...
You can customize the selected segment background of segmented control and each segment item.
...
You can customize the selected segment text color of segmented control and each segment item.
