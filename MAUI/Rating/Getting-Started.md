---
layout: post
title: Getting Started with .NET MAUI Rating | Syncfusion®
description: Learn how to get started with Syncfusion® .NET MAUI Rating (SfRating) control, its elements and more.
platform: maui
control: Rating
documentation: ug
---
