---
layout: post
title: .NET MAUI SfTabView: Getting Started | Syncfusion®
description: Learn all about getting started with the Syncfusion® .NET MAUI Tab View control, its elements, and more.
platform: MAUI
control: SfTabView
documentation: UG
---
