---
layout: post
title: Track in .NET MAUI Slider | Syncfusion®
description: Learn how to customize the track in the Syncfusion® .NET MAUI Slider, including color, height, extent, and disabled-state styling.
platform: maui
control: SfSlider
documentation: ug
---
