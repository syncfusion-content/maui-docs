...
description: Learn how to migrate from Syncfusion® Xamarin RangeSlider to the Syncfusion® .NET MAUI Slider, including equivalent properties, events, and styling mappings.
platform: MAUI
control: SfSlider
documentation: ug
---  

# Migrate from Xamarin RangeSlider to .NET MAUI Slider
