---
layout: post
title: Migrate from Xamarin SfRangeSlider to .NET MAUI SfSlider | Syncfusion<sup>®</sup> 
description: Learn here all about Migrating from Syncfusion<sup>®</sup> Xamarin RangeSlider to Syncfusion<sup>®</sup> .NET MAUI Slider control and more.
platform: MAUI
control: SfSlider
documentation: ug
---  
