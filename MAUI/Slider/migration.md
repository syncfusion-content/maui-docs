---
layout: post
title: Migrate from Xamarin RangeSlider to .NET MAUI Slider | Syncfusion®
description: Learn how to migration from Syncfusion® Xamarin RangeSlider to the Syncfusion® .NET MAUI Slider, including equivalent properties, events, and styling mappings.
platform: MAUI
control: SfSlider
documentation: ug
---  

# Migration from Xamarin RangeSlider to .NET MAUI Slider
