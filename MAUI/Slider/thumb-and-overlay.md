...
description: Learn how to customize the thumb and thumb overlay in the Syncfusion® .NET MAUI Slider, including size, color, stroke, and disabled-state styling.
platform: maui
control: SfSlider
documentation: ug
---
