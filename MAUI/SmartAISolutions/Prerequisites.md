...
First, open [Visual Studio](https://visualstudio.microsoft.com/) and [create a new .NET MAUI app](https://learn.microsoft.com/dotnet/maui/get-started/first-app&tabs=vswin&pivots=devices-android).
