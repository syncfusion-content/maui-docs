...
<td>Limits the number of characters that can be entered in the embedded input view.</td>
</tr>
...
<td>Customizes the background of the text input container.</td>
</tr>
...
<td>Controls the visual style of the input container using the available <code>ContainerType</code> values.</td>
</tr>
...
<td>Controls the color used for focused and active visual elements, such as the floating hint and focused stroke.</td>
</tr>
...
<td>Moves the <code>hint</code> above the input area when the input view receives focus or contains text, keeping the field label visible while editing.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Animates the <code>hint</code> when it transitions between its resting and floating positions.</td>
</tr>
...
<td>Customizes the appearance of the <code> error text </code> displayed below the input area.</td>
</tr>
...
<td>Displays a validation message below the input area when the control is in an error state.</td>
</tr>
...
<td>Controls the thickness of the container border while the input view has focus.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Shows the control in its error state, including error styling and error text when provided.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Displays a label that describes the expected value for the input field.</td>
</tr>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Core.LabelStyle.html" aria-label="View LabelStyle type in API reference">LabelStyle</a></td>
<td>Customizes the appearance of the hint in both its resting and floating states.</td>
</tr>
...
<td>Controls the padding around the embedded input view within the container.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Enables or disables user interaction with the text input layout and its embedded input view.</td>
</tr>
...
<td>Displays custom content before the input area, such as an icon, text, or button.</td>
</tr>
...
<td>Controls where the leading view appears relative to the input area using the supported <code> ViewPosition </code> values. Document the behavior of each enum value separately if needed.</td>
</tr>
...
<td>Controls how rounded the outline border appears when using an outlined container style.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Displays a character counter for the embedded input view. <code> Character count </code>behavior when CharMaxLength is not set should be verified.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Shows or hides the helper text area below the input field.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Shows or hides the leading view without removing it from the layout configuration.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Shows or hides the trailing view without removing it from the layout configuration.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
<td>Customizes the border of the text input container.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.string" aria-label="View String type in API reference">string</a></td>
<td>Represents the current text content of the embedded input view.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.view" aria-label="View View type in API reference">View</a></td>
<td>Displays custom content after the input area, such as an icon, action button, or status indicator.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.double" aria-label="View Double type in API reference">double</a></td>
<td>Controls the thickness of the container border when the input view is not focused.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.boolean" aria-label="View Boolean type in API reference">bool</a></td>
<td>Moves focus to the embedded input view, allowing users to begin editing the field.</td>
</tr>
...
<td>Removes focus from the embedded input view and ends the active editing state.</td>
</tr>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1?view=net-10.0" aria-label="View EventHandler type in API reference">EventHandler&lt;<a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Core.PasswordVisibilityToggledEventArgs.html" aria-label="View PasswordVisibilityToggledEventArgs type in API reference">PasswordVisibilityToggledEventArgs&gt;</a></a></td>
<td>Triggered when the <code> password visibility </code> button changes the password display between masked and visible states.</td>
</tr>
