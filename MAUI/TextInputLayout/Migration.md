---
layout: post
title: Migrating from Xamarin to .NET MAUI SfTextInputLayout | Syncfusion<sup>®</sup> 
description: Learn all about Migrating from Syncfusion<sup>®</sup> Xamarin TextInputLayout to Syncfusion<sup>®</sup> .NET MAUI TextInputLayout control and more here.
platform: maui
