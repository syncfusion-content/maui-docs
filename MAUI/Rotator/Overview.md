...
The following table summarizes the globalization support available in the [SfRotator](https://www.syncfusion.com/maui-controls/maui-rotator) control.
...
- [Getting Started](https://help.syncfusion.com/maui/rotator/getting-started) - step-by-step guide to begin using the Rotator control.  
- [Navigation](https://help.syncfusion.com/maui/rotator/navigation-modes) - configure navigation modes and placement.  
- [Customization](https://help.syncfusion.com/maui/rotator/navigation-customization) - customize appearance and behavior. 
