...
<a href="https://www.syncfusion.com/maui-controls/maui-rotator" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Rotator" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/rotator" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  <div class="form-content">
   <div class="card-header">
    ...
    <a href="https://support.syncfusion.com/kb/cross-platforms/section/1418" class="explore-link">
Search KB's
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <div class="form-description">
      Explore a real-world application that demonstrates the practical use of the Rotator.
    </div>
