...
description: Essential® UI Kit for .NET MAUI contains elegantly designed XAML templates for MAUI apps.
platform: maui
control: Essential<sup>®</sup> UI Kit for .NET MAUI Forms
documentation: ug
---
# Syncfusion<sup>®</sup> Essential<sup>®</sup> UI Kit for .NET MAUI Forms Designs
