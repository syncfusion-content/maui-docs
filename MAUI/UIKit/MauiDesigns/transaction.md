...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Transaction/CheckoutPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              Review items, select delivery address, apply coupons, and complete the purchase securely.
</div>
</div>
</div>
<!-- Card 2 -->
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Transaction/PaymentSuccessPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Transaction/PaymentFailurePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                Informs users of a failed payment and provides a clear option to retry the transaction.
</div>
</div>
</div>
<div class="form-card">
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Transaction/MyCardsPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                View and manage saved credit and debit cards for faster, secure checkout.
</div>
</div>
</div>
</div>
