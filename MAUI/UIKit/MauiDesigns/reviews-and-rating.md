...
description: Essential® UI Kit for .NET MAUI contains elegantly designed XAML templates for MAUI Review and Rating apps.
platform: maui
control: Essential<sup>®</sup> UI Kit for .NET MAUI
documentation: ug
---

# Syncfusion<sup>®</sup> Essential<sup>®</sup> UI Kit for .NET MAUI Review and Rating Designs
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Feedback/FeedbackPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              View customer ratings, read reviews, and share feedback to help others make informed decisions.
</div>
</div>
</div>
<div class="form-card">
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Feedback/ReviewPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
              Rate the product, upload photos or videos, and share your experience with other customers.
</div>
</div>
</div>
</div>
