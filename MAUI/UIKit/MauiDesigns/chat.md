...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Chat/RecentChatPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              View recent conversations with message previews, timestamps, and quick access to chat threads.
</div>
</div>
</div>
<div class="form-card">
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Chat/ChatMessagePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
              Read and reply to messages with text, images, and timestamps in a focused conversation screen.
</div>
</div>
</div>
</div>
