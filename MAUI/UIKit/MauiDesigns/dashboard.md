...
<div class="form-description">
              Track market indices, view performance charts, and monitor investments from a single dashboard.
</div>
</div>
</div>
<!-- Card 2 -->
...
<div class="form-description">
               Monitor daily calories, heart rate, steps, sleep, and health metrics in one simple, visual dashboard.
</div>
</div>
</div>
<!-- Card 3 -->
...
<div class="form-description">
                Review daily calorie intake and nutrient breakdown by meals to stay on track with health goals.
</div>
</div>
</div>
<div class="form-card">
...
<div class="form-description">
                View a chronological timeline of daily activities, meals, workouts, and events for better day planning.
</div>
</div>
</div>
<!-- Card 5 -->
...
<div class="form-description">
                Explore key milestones and achievements that shaped the company’s growth over the years.
</div>
</div>
</div>
<div class="form-card">
...
<div class="form-description">
                Manage cards, track balances, and review recent transactions from a single, secure wallet view.
</div>
</div>
</div>
<div class="form-card">
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Dashboard/RestaurantDashboardPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                Track orders, revenue, customers, and payment status to manage restaurant operations efficiently.
</div>
</div>
</div>
</div>
