...
<h3 class="form-title">Order Delivery Tracking
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Tracking/OrderTracking.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              Track order status, delivery progress, address, and price details in one clear, real‑time view.
</div>
</div>
</div>
</div>
