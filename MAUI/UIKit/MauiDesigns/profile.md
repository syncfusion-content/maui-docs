...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Profile/AuthorProfilePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              Manage profile details, enable night mode, adjust text size, and access app settings easily.
</div>
</div>
</div>
<!-- Card 2 -->
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Profile/ContactProfilePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
               View contact availability, phone, email, and shared media in one clear profile screen.
</div>
</div>
</div>
<!-- Card 3 -->
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Profile/ChatProfilePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                View and manage chat profile details, availability status, notifications, and support options.
</div>
</div>
</div>
<div class="form-card">
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Profile/MasterProfilePage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                Access main navigation options like home, interests, bookmarks, activity, and profile from one central menu.
</div>
</div>
</div>
<!-- Card 5 -->
...
<div class="form-description">
                Track personal health stats like age, weight, calories, heart rate, and daily wellness insights in one view.
</div>
</div>
</div>
</div>
