...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Bookmark/WishlistPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
               Review saved products, see prices and discounts, and quickly add favorites to the cart.
</div>
</div>
</div>
<!-- Card 2 -->
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Bookmark/CartPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
               Review selected items, adjust quantities, remove products, and prepare for checkout.
</div>
</div>
</div>
<!-- Card 3 -->
...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/Bookmark/ArticleBookmarkPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
<svg xmlns="http://www.w3.org/2000/svg"
...
<div class="form-description">
                Access saved articles quickly and continue reading favorite content anytime.
</div>
</div>
</div>
</div>
