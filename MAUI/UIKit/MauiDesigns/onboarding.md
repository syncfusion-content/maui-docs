...
<a href="https://github.com/syncfusion/essential-ui-kit-for-.net-maui/blob/master/EssentialMAUIUIKit/EssentialMAUIUIKit/Views/OnBoarding/OnboardingPage.xaml"
              target="_blank"
              class="source-icon"
              title="View Source">
...
<div class="form-description">
              Introduces nearby food discovery features and guides users through the app step by step.
</div>
</div>
</div>
</div>
