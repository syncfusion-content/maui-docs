...
description: Essential® UI Kit for .NET MAUI contains elegantly designed XAML templates for MAUI About-Us apps.
platform: maui
control: Essential<sup>®</sup> UI Kit for .NET MAUI
documentation: ug
---

# Syncfusion<sup>®</sup> Essential<sup>®</sup> UI Kit for .NET MAUI About-Us Designs
