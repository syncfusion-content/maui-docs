...
<tr>
<td>{{'[ItemTappedEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.ItemTappedEventArgs.html#Syncfusion_ListView_XForms_ItemTappedEventArgs_ItemData)'| markdownify }}</td>
...
<tr>
<td>{{'[ItemHoldingEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.ItemHoldingEventArgs.html#Syncfusion_ListView_XForms_ItemHoldingEventArgs_ItemData)'| markdownify }}</td>
...
<tr>
<td>{{'[ItemDoubleTappedEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.ItemDoubleTappedEventArgs.html#Syncfusion_ListView_XForms_ItemDoubleTappedEventArgs_ItemData)'| markdownify }}</td>
...
<tr>
<td>{{'[ItemAppearingEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.ItemAppearingEventArgs.html#Syncfusion_ListView_XForms_ItemAppearingEventArgs_ItemData)'| markdownify }}</td>
...
<tr>
<td>{{'[ItemDisappearingEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.ItemDisappearingEventArgs.html#Syncfusion_ListView_XForms_ItemDisappearingEventArgs_ItemData)'| markdownify }}</td>
...
<tr>
<td>{{'[QueryItemSizeEventArgs.ItemData](https://help.syncfusion.com/cr/xamarin/Syncfusion.ListView.XForms.QueryItemSizeEventArgs.html#Syncfusion_ListView_XForms_QueryItemSizeEventArgs_ItemData)'| markdownify }}</td>
