...
<tr valign="top">
    ...
    <td>Selects a built-in shimmer placeholder layout using the supported <code> ShimmerType </code> values.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the direction in which the shimmer highlight moves using the supported <code>ShimmerWaveDirection</code> values.</td>
</tr>
