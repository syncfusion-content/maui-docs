...
description: Learn about customization options in Syncfusion® .NET MAUI Shimmer (SfShimmer) control including fill color, wave color, wave direction, and animation duration.
platform: maui
control: SfShimmer
documentation: ug
---
