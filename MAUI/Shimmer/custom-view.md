...
description: Learn about custom view support in Syncfusion® .NET MAUI Shimmer control to create shimmer effects using custom layouts and framework elements.
platform: maui
control: SfShimmer
documentation: ug
---
