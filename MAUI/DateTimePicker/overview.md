...
<tr>
<td><a href="/maui/datetimepicker/overview">Date Time Picker</a></td>
...
- [Getting Started](https://help.syncfusion.com/maui/datetimepicker/getting-started) shows a step‑by‑step guide to begin using the Date Time Picker control.  
- [Formatting](https://help.syncfusion.com/maui/datetimepicker/formatting) explains how to configure date and time formats.  
- [Customization](https://help.syncfusion.com/maui/datetimepicker/customizations) helps customize appearance and behavior.  
...
<a href="https://www.syncfusion.com/maui-controls/maui-datetimepicker" class="explore-link">
Explore Features
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://github.com/syncfusion/maui-demos/tree/master/MAUI/Picker/SampleBrowser.Maui.Picker/Samples/DateTimePicker" class="explore-link">
    View Samples
  <span class="card-icon card-arrow"></span>
</a>
  </div>
...
<div class="form-card" target="_blank">
  ...
  <div class="card-header">
    ...
    <a href="https://www.syncfusion.com/tutorial-videos/maui/date-time-picker" class="explore-link">
    Watch now
  <span class="card-icon card-arrow"></span>
</a>
  </div>
