...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.collections.objectmodel.observablecollection-1" aria-label="View ObservableCollection type in API reference">ObservableCollection&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.timespan" aria-label="View TimeSpan type in API reference">TimeSpan&gt;</a></a></td>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.nullable" aria-label="View Nullable type in API reference">Nullable&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/system.timespan" aria-label="View TimeSpan type in API reference">TimeSpan&gt;</a></a></td>
