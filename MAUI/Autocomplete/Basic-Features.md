---
layout: post
title: Basic Features in .NET MAUI Autocomplete control | Syncfusion<sup>®</sup>
description: Learn about Basic Features support in Syncfusion<sup>®</sup> .NET MAUI Autocomplete (SfAutocomplete) control and more.
platform: maui
