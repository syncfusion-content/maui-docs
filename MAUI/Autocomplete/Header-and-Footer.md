---
layout: post
title: Header and Footer in MAUI Autocomplete control | Syncfusion<sup>®</sup>
description: Learn about Header and Footer support in Syncfusion<sup>®</sup> MAUI Autocomplete (SfAutocomplete) control and more details.
platform: maui
