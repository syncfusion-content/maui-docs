...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.returntype" aria-label="View ReturnType type in API reference">ReturnType</a></td>
...
<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.OccurrenceMode.html" aria-label="View TextHighlightMode type in API reference">OccurrenceMode</a></td>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.style?view=net-maui-10.0" aria-label="View TokenItemStyle type in API reference">Style</a></td>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler&lt;FocusEventArgs&gt; type in API reference">EventHandler&lt;<a href="https://learn.microsoft.com/en-us/dotnet/api/microsoft.maui.controls.focuseventargs" aria-label="View FocusEventArgs type in API reference">FocusEventArgs</a>&gt;</a></td>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler&lt;SelectionChangedEventArgs&gt; type in API reference">EventHandler&lt;<a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.SelectionChangedEventArgs.html" aria-label="View SelectionChangedEventArgs type in API reference">SelectionChangedEventArgs</a>&gt;</a></td>
...
<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.eventhandler-1" aria-label="View EventHandler&lt;SelectionChangingEventArgs&gt; type in API reference">EventHandler&lt;<a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Inputs.SelectionChangingEventArgs.html" aria-label="View SelectionChangingEventArgs type in API reference">SelectionChangingEventArgs</a>&gt;</a></td>
