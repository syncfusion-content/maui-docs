---
layout: post
title: Selection in .NET MAUI Autocomplete control | Syncfusion<sup>®</sup>
description: Learn all about Selection support in Syncfusion<sup>®</sup> .NET MAUI Autocomplete (SfAutocomplete) control and more here.
platform: maui
