...
You can add the desired image in to the chat by opening the device’s gallery when attachment button is tapped.(https://github.com/SyncfusionExamples/how-to-attach-image-from-gallery-in-.net-maui-chat).
