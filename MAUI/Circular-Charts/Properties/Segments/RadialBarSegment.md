...
# RadialBarSegment API in .NET MAUI Circular Chart
...
<tr valign="top">
    ...
    <td>Represents the segment’s current animation progress and updates as the radial bar segment is animated into or updated within the chart.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.RadialBarSegment.html#Syncfusion_Maui_Charts_RadialBarSegment_EndAngle" aria-label="View EndAngle property in API reference">EndAngle</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.single" aria-label="View float type in API reference">float</a></td>
    <td>Provides the ending angle of the radial bar segment, defining where the rendered arc ends.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the brush used to render the interior of the radial bar segment.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the transparency of the radial bar segment, where lower values make the segment appear more transparent.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.RadialBarSegment.html#Syncfusion_Maui_Charts_RadialBarSegment_StartAngle" aria-label="View StartAngle property in API reference">StartAngle</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.single" aria-label="View float type in API reference">float</a></td>
    <td>Provides the starting angle of the radial bar segment, defining where the rendered arc begins.</td>
</tr>
