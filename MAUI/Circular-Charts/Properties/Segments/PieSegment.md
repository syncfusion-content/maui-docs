...
# PieSegment API in .NET MAUI Circular Chart
...
<tr valign="top">
    ...
    <td>Represents the segment’s current animation progress and changes as the segment is animated into or updated within the chart.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.PieSegment.html#Syncfusion_Maui_Charts_PieSegment_EndAngle" aria-label="View EndAngle property in API reference">EndAngle</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Provides the ending angle of the pie segment within the circular chart, defining where the segment arc ends.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the transparency of the chart segment, where lower values make the segment appear more transparent.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.PieSegment.html#Syncfusion_Maui_Charts_PieSegment_Radius" aria-label="View Radius property in API reference">Radius</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.single" aria-label="View float type in API reference">float</a></td>
    <td>Provides the rendered radius of the pie segment within the circular chart.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.ChartSeries.html" aria-label="View ChartSeries type in API reference">ChartSeries</a></td>
    <td>Provides the chart series that owns and renders the segment.</td>
</tr>

<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.PieSegment.html#Syncfusion_Maui_Charts_PieSegment_StartAngle" aria-label="View StartAngle property in API reference">StartAngle</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Provides the starting angle of the pie segment within the circular chart, defining where the segment arc begins.</td>
</tr>
...
<tr valign="top">
    <td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Charts.PieSegment.html#Syncfusion_Maui_Charts_PieSegment_YValue" aria-label="View YValue property in API reference">YValue</a></td>
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Provides the data value represented by the pie segment, which determines the segment's proportional size within the series.</td>
</tr>
</table>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.componentmodel.inotifypropertychanged" aria-label="View PropertyChangedEventHandler type in API reference">PropertyChangedEventHandler</a></td>
    <td>Triggered when a segment property changes, allowing updates that depend on the segment's current state or appearance.</td>
</tr>
</table>