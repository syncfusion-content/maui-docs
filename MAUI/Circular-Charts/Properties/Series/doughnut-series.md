...
description: This section lists the public API members of the DoughnutSeries available in the Syncfusion® .NET MAUI Circular Chart (SfCircularChart).
platform: maui
...
<tr valign="top">
    ...
    <td>Returns the <code>diameter of the doughnut hole</code> as a fraction of the <code>chart radius</code>, derived from <code>InnerRadius</code>. <code>Read-only</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Renders a <code>custom view</code> inside the <code>doughnut hole</code>, useful for <code>total values</code>, <code>titles</code>, <code>images</code>, or any <code>MAUI layout element</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Animates the <code>doughnut series</code> when it first appears and whenever the <code>underlying data changes</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Displays a <code>tooltip</code> with <code>segment details</code> when the user hovers over or taps a <code>slice</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Sets the <code>angular position</code>, in <code>degrees</code>, where the <code>doughnut layout</code> stops drawing. Defaults to <code>360</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.boolean" aria-label="View bool type in API reference">bool</a></td>
    <td>Pushes every <code>slice</code> outward from the <code>doughnut center</code> simultaneously.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Defines the <code>doughnut hole size</code> as a fraction of the <code>outer radius</code>, between <code>0</code> and <code>1</code>. Defaults to <code>0.4</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Supplies the <code>collection of business objects</code> used to plot the <code>doughnut chart</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Controls the <code>overall size</code> of the <code>doughnut</code> as a fraction of the <code>available plot area</code>, between <code>0</code> and <code>1</code>. Defaults to <code>0.8</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/system.double" aria-label="View double type in API reference">double</a></td>
    <td>Sets the <code>angular position</code>, in <code>degrees</code>, where the <code>doughnut layout</code> begins drawing. Defaults to <code>0</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td><a href="https://learn.microsoft.com/dotnet/api/microsoft.maui.controls.brush" aria-label="View Brush type in API reference">Brush</a></td>
    <td>Paints the <code>outline</code> of each <code>doughnut slice</code>.</td>
</tr>
