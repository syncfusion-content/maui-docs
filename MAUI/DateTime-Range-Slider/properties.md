...
<table>
	...
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SfDateTimeRangeSlider.html#Syncfusion_Maui_Sliders_SfDateTimeRangeSlider_IntervalType" aria-label="View IntervalType property in API reference">IntervalType</a></td>
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SliderDateIntervalType.html" aria-label="View SliderDateIntervalType type in API reference">SliderDateIntervalType</a></td>
		<td>Specifies how date intervals are grouped for ticks and labels, such as <code>Auto</code>, <code>Days</code>, <code>Months</code>, or <code>Years</code>.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SfDateTimeRangeSlider.html#Syncfusion_Maui_Sliders_SfDateTimeRangeSlider_Orientation" aria-label="View Orientation property in API reference">Orientation</a></td>
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SliderOrientation.html" aria-label="View SliderOrientation type in API reference">SliderOrientation</a></td>
		<td>Defines whether the slider is displayed horizontally or vertically.</td>
	</tr>
	<tr valign="top">
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SfDateTimeRangeSlider.html#Syncfusion_Maui_Sliders_SfDateTimeRangeSlider_StepDuration" aria-label="View StepDuration property in API reference">StepDuration</a></td>
		<td><a href="https://help.syncfusion.com/cr/maui/Syncfusion.Maui.Sliders.SliderStepDuration.html" aria-label="View SliderStepDuration type in API reference">SliderStepDuration</a></td>
		<td>Defines the discrete step size used when moving the thumbs across date values.</td>
	</tr>
	<tr valign="top">
		...
		<td><a href="https://learn.microsoft.com/en-us/dotnet/api/system.datetime" aria-label="View DateTime type in API reference">DateTime</a></td>
	...
	<tr valign="top">
		...
		<td>Controls how the thumbs move during dragging, such as dragging the thumbs independently or together.</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>Customizes the appearance of the dividers between range segments.</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>Defines where edge labels appear in relation to the slider track.</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>Defines where labels are placed relative to the slider track.</td>
	</tr>
	<tr valign="top">
	...
	<tr valign="top">
		...
		<td>Customizes the tooltip that appears while dragging.</td>
	</tr>
	<tr valign="top">
