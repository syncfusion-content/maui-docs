...
* `Background`: Specifies the background color of the text annotation.
...
The .NET MAUI Image Editor supports customizing the background color of text annotations using `Background` property.
