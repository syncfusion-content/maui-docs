...
{% youtube
"youtube:https://www.youtube.com/watch?si=_WKWcnGgob0DofXe&v=Gkkh52xSehM&feature=youtu.be"%}
...
## Step 2: Install the Syncfusion<sup>®</sup> .NET MAUI Image Editor NuGet package
...
3. Run the command `dotnet add package Syncfusion.Maui.ImageEditor` to install the Syncfusion<sup>®</sup> .NET MAUI ImageEditor package.
