...
description: Explore the AI Coding Assistants Tools Prompt Library to boost .NET MAUI productivity with code generation, configuration examples, and contextual guidance.
...
Speed up .NET MAUI AI development using these ready-made prompts for popular Syncfusion components. Each prompt is short, easy to understand, and focused on real tasks—like quick setups, tweaks, and fixes.
...
* Run the prompt using either of the following AI tools:
  ...
  * **Skills**: Skills can also run automatically based on the query, or can be called explicitly using the `/syncfusion-maui-grid` skill.
...
The Syncfusion .NET MAUI AI Data Grid delivers fast, flexible tables for large datasets with built-in interactivity.

{% promptcards %}
{% promptcard Paging and Sorting %}
How do I enable paging and sorting in the Syncfusion .NET MAUI AI Grid?
{% endpromptcard %}
...
What's the code to implement full CRUD operations in Syncfusion .NET MAUI AI Grid?
{% endpromptcard %}
...
The Syncfusion .NET MAUI AI Chart suite offers versatile visualization tools across various series types for insightful data representation.
...
Show me how to enable range selection in a Syncfusion .NET MAUI AI Chart.
{% endpromptcard %}
{% promptcard Chart Types Overview %}
What chart types are available in Syncfusion .NET MAUI AI Chart, and how do I configure them?
{% endpromptcard %}
...
Enable print functionality for a Syncfusion .NET MAUI AI Chart component.
{% endpromptcard %}
...
The Syncfusion .NET MAUI AI Schedule component helps manage events, resources, and timelines with powerful views and customization.

{% promptcards %}
{% promptcard Module Injection %}
How do I inject required modules into the Syncfusion .NET MAUI AI Schedule component?
{% endpromptcard %}
...
How can I configure timezone support in the Syncfusion .NET MAUI AI Schedule?
{% endpromptcard %}
...
The Syncfusion .NET MAUI AI Kanban organizes tasks in columns with drag-and-drop, swimlanes, and templating for agile workflows.

{% promptcards %}
{% promptcard Data Binding %}
How do I bind local or remote data to the Syncfusion .NET MAUI AI Kanban board?
{% endpromptcard %}
{% promptcard Sorting %}
...
The Syncfusion .NET MAUI AI RichTextEditor offers a modern WYSIWYG editor with extensive formatting, media, and integration features.
...
How do I integrate a .NET MAUI AI form and validate input?
{% endpromptcard %}
...
The Syncfusion .NET MAUI AI Calendar supports flexible date selection, localization, and custom rendering.

{% promptcards %}
{% promptcard Date Range Selection %}
How do I enable date range selection in the Syncfusion .NET MAUI AI Calendar?
{% endpromptcard %}
...
* [SKills](https://help.syncfusion.com/maui/skills/controls-user-skills)
* [MCP Server](https://help.syncfusion.com/maui/ai-coding-assistant/mcp-server)