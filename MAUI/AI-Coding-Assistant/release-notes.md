...
- The [@syncfusion/maui-assistant](https://www.npmjs.com/package/@syncfusion/maui-assistant) npm package has been migrated to the [Syncfusion.Maui.MCP](https://www.nuget.org/packages/Syncfusion.Maui.MCP) .NET package. As part of this transition, [@syncfusion/maui-assistant](https://www.npmjs.com/package/@syncfusion/maui-assistant) package has been deprecated and will no longer receive updates.

- The coding assistant tool identifier has been changed from **`#SyncfusionMAUIAssistant`** to **`search_docs`** for a better naming convention.