...
## Step 2: Install the Syncfusion<sup>®</sup> MAUI Chart NuGet Package

1. In **Solution Explorer,** right-click the project and choose **Manage NuGet Packages.**
2. Search for [Syncfusion.Maui.Chart](https://www.nuget.org/packages/Syncfusion.Maui.Chart/) and install the latest version.
