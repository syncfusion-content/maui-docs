...
The following table summarizes the globalization support available in the [SfPolarChart](https://www.syncfusion.com/maui-controls/maui-polar-charts) control.
...
- [Getting Started](https://help.syncfusion.com/maui/polar-charts/getting-started) - step-by-step guide to begin using the Polar Chart control.
- [Chart Types](https://help.syncfusion.com/maui/polar-charts/polararea) - explore different polar charts types.
- [Customization](https://help.syncfusion.com/maui/polar-charts/appearance) - customize appearance and interaction settings.
