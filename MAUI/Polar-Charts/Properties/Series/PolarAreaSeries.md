...
# PolarAreaSeries API in .NET MAUI Polar Chart
...
<tr valign="top">
    ...
    <td>Controls whether the polar area connects the last data point back to the first data point, forming a closed shape. When disabled, the series remains open between the first and last points.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the brush used to draw the outline of the polar area.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Defines a dash pattern for the series outline, allowing the border to be rendered with dashed or dotted strokes.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Controls the thickness of the series outline. The default value is <code>2</code>.</td>
</tr>
...
<tr valign="top">
    ...
    <td>Returns the index of the data point located at the specified chart coordinates. If no data point is found at the given position, no valid data-point index is returned.</td>
</tr>
</table>
