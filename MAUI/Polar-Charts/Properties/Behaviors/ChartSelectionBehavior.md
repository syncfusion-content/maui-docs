---
layout: post
title: ChartSelectionBehaviors in .NET MAUI Polar Chart | Syncfusion®
description: This section lists the public API members of selection behaviors available in the Syncfusion® .NET MAUI Polar Chart (SfPolarChart) API.
platform: maui
control: SfPolarChart
documentation: ug
---

# ChartSelectionBehaviors API in .NET MAUI Polar Chart
