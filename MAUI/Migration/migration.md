...
To migrate easier from Xamarin to .NET MAUI, we kept most of the names of the components from the Xamarin were kept in the .NET MAUI. However, to maintain the consistency of component naming in the .NET MAUI, we renamed some of the components. Below are the components with migration guideline details.
