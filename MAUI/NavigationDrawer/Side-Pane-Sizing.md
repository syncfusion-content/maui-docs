---
layout: post
title: Setting Sliding Panel size in .NET MAUI Navigation Drawer | Syncfusion<sup>®</sup>
description: Learn here all about Setting Sliding Panel size support in Syncfusion<sup>®</sup> .NET MAUI Navigation Drawer (SfNavigationDrawer) control and more.
platform: maui
