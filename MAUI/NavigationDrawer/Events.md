...
description: Learn about Events support in Syncfusion<sup>®</sup> Essential Studio<sup>®</sup> .NET MAUI Navigation Drawer (SfNavigationDrawer) control, its elements, and more.
platform: maui
